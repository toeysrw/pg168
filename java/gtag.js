...
(function () {
    ...
    */
    ...
    var nb = function (a, b, c, d, e) {
        var f = F.createElement("script"); mb(f, d, kb); f.type = "text/javascript"; f.async = !0; var g, l = a, m = Qa(), n = m ? m.createScriptURL(l) : l; g = new Sa(n, Ra); f.src = g instanceof Sa && g.constructor === Sa ? g.h : "type_error:TrustedResourceUrl"; var p, q, t, u = null == (t = (q = (f.ownerDocument && f.ownerDocument.defaultView || window).document).querySelector) ? void 0 : t.call(q, "script[nonce]"); (p = u ? u.nonce || u.getAttribute("nonce") || "" : "") && f.setAttribute("nonce", p); jb(f, b); c && (f.onerror = c); if (e) e.appendChild(f); else {
            var r =
                F.getElementsByTagName("script")[0] || F.body || F.head; r.parentNode.insertBefore(f, r)
        } return f
    }, ob = function () { if (hb) { var a = hb.toLowerCase(); if (0 === a.indexOf("https://")) return 2; if (0 === a.indexOf("http://")) return 3 } return 1 }, pb = function (a, b, c, d, e) {
        var f; f = void 0 === f ? !0 : f; var g = e, l = !1; g || (g = F.createElement("iframe"), l = !0); mb(g, c, lb); d && k(d, function (n, p) { g.dataset[n] = p }); f && (g.height = "0", g.width = "0", g.style.display = "none", g.style.visibility = "hidden"); if (l) {
            var m = F.body && F.body.lastChild || F.body || F.head;
            m.parentNode.insertBefore(g, m)
        } jb(g, b); void 0 !== a && (g.src = a); return g
    }, qb = function (a, b, c) { var d = new Image(1, 1); d.onload = function () { d.onload = null; b && b() }; d.onerror = function () { d.onerror = null; c && c() }; d.src = a }, rb = function (a, b, c, d) { a.addEventListener ? a.addEventListener(b, c, !!d) : a.attachEvent && a.attachEvent("on" + b, c) }, sb = function (a, b, c) { a.removeEventListener ? a.removeEventListener(b, c, !1) : a.detachEvent && a.detachEvent("on" + b, c) }, G = function (a) { E.setTimeout(a, 0) }, tb = function (a, b) {
        return a && b && a.attributes &&
            a.attributes[b] ? a.attributes[b].value : null
    }, ub = function (a) { var b = a.innerText || a.textContent || ""; b && " " != b && (b = b.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "")); b && (b = b.replace(/(\xa0+|\s{2,}|\n|\r\t)/g, " ")); return b }, vb = function (a) { var b = F.createElement("div"), c = b, d = ab("A<div>" + a + "</div>"); void 0 !== c.tagName && bb(c); c.innerHTML = $a(d); b = b.lastChild; for (var e = []; b.firstChild;)e.push(b.removeChild(b.firstChild)); return e }, wb = function (a, b, c) {
        c = c || 100; for (var d = {}, e = 0; e < b.length; e++)d[b[e]] = !0; for (var f = a, g = 0; f &&
            g <= c; g++) { if (d[String(f.tagName).toLowerCase()]) return f; f = f.parentElement } return null
    }, xb = function (a) { var b; try { b = gb.sendBeacon && gb.sendBeacon(a) } catch (c) { db("TAGGING", 15) } b || qb(a) }, yb = function (a, b) { var c = a[b]; c && "string" === typeof c.animVal && (c = c.animVal); return c }, zb = function () { var a = E.performance; if (a && oa(a.now)) return a.now() };/*
     jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var Ab = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/, Bb = function (a) { if (null == a) return String(a); var b = Ab.exec(Object.prototype.toString.call(Object(a))); return b ? b[1].toLowerCase() : "object" }, Cb = function (a, b) { return Object.prototype.hasOwnProperty.call(Object(a), b) }, J = function (a) {
        if (!a || "object" != Bb(a) || a.nodeType || a == a.window) return !1; try { if (a.constructor && !Cb(a, "constructor") && !Cb(a.constructor.prototype, "isPrototypeOf")) return !1 } catch (c) { return !1 } for (var b in a); return void 0 ===
            b || Cb(a, b)
    }, N = function (a, b) { var c = b || ("array" == Bb(a) ? [] : {}), d; for (d in a) if (Cb(a, d)) { var e = a[d]; "array" == Bb(e) ? ("array" != Bb(c[d]) && (c[d] = []), c[d] = N(e, c[d])) : J(e) ? (J(c[d]) || (c[d] = {}), c[d] = N(e, c[d])) : c[d] = e } return c }; var Db = function (a) { if (void 0 === a || qa(a) || J(a)) return !0; switch (typeof a) { case "boolean": case "number": case "string": case "function": return !0 }return !1 }; var Eb = function () {
        var a = function (b) { return { toString: function () { return b } } }; return {
            Ih: a("consent"), Ef: a("convert_case_to"), Ff: a("convert_false_to"), Gf: a("convert_null_to"), Hf: a("convert_true_to"), If: a("convert_undefined_to"), dk: a("debug_mode_metadata"), xb: a("function"), Qe: a("instance_name"), vi: a("live_only"), wi: a("malware_disabled"), xi: a("metadata"), Ai: a("original_activity_id"), gk: a("original_vendor_template_id"), fk: a("once_on_load"), zi: a("once_per_event"), Mg: a("once_per_load"), hk: a("priority_override"),
            ik: a("respected_consent_types"), Qg: a("setup_tags"), Rg: a("tag_id"), Sg: a("teardown_tags")
        }
    }(); var ac;
    var bc = [], cc = [], dc = [], ec = [], fc = [], gc = {}, hc, ic, kc = function () { var a = jc; ic = ic || a }, lc, mc = function (a, b) {
        var c = a["function"], d = b && b.event; if (!c) throw Error("Error: No function name given for function call."); var e = gc[c], f = {}, g; for (g in a) a.hasOwnProperty(g) && 0 === g.indexOf("vtp_") && (e && d && d.Xg && d.Xg(a[g]), f[void 0 !== e ? g : g.substr(4)] = a[g]); e && d && d.Wg && (f.vtp_gtmCachedValues = d.Wg); if (b) {
            if (null == b.name) {
                var l; a: {
                    var m = b.index; if (null == m) l = ""; else {
                        var n; switch (b.type) {
                            case 2: n = bc[m]; break; case 1: n = ec[m]; break;
                            default: l = ""; break a
                        }var p = n && n[Eb.Qe]; l = p ? String(p) : ""
                    }
                } b.name = l
            } e && (f.vtp_gtmEntityIndex = b.index, f.vtp_gtmEntityName = b.name)
        } return void 0 !== e ? e(f) : ac(c, f, b)
    }, oc = function (a, b, c) { c = c || []; var d = {}, e; for (e in a) a.hasOwnProperty(e) && (d[e] = nc(a[e], b, c)); return d }, nc = function (a, b, c) {
        if (qa(a)) {
            var d; switch (a[0]) {
                case "function_id": return a[1]; case "list": d = []; for (var e = 1; e < a.length; e++)d.push(nc(a[e], b, c)); return d; case "macro": var f = a[1]; if (c[f]) return; var g = bc[f]; if (!g || b.ef(g)) return; c[f] = !0; var l =
    ...
    }, pc = function (a, b, c) { try { return hc(oc(a, b, c)) } catch (d) { JSON.stringify(a) } return 2 }; var sc = function (a) { function b(t) { for (var u = 0; u < t.length; u++)d[t[u]] = !0 } for (var c = [], d = [], e = qc(a), f = 0; f < cc.length; f++) { var g = cc[f], l = rc(g, e); if (l) { for (var m = g.add || [], n = 0; n < m.length; n++)c[m[n]] = !0; b(g.block || []) } else null === l && b(g.block || []); } for (var p = [], q = 0; q < ec.length; q++)c[q] && !d[q] && (p[q] = !0); return p }, rc = function (a, b) {
    ...
    }, qc = function (a) { var b = []; return function (c) { void 0 === b[c] && (b[c] = pc(dc[c], a)); return b[c] } }; var tc = { Oi: function (a, b) { b[Eb.Ef] && "string" === typeof a && (a = 1 == b[Eb.Ef] ? a.toLowerCase() : a.toUpperCase()); b.hasOwnProperty(Eb.Gf) && null === a && (a = b[Eb.Gf]); b.hasOwnProperty(Eb.If) && void 0 === a && (a = b[Eb.If]); b.hasOwnProperty(Eb.Hf) && !0 === a && (a = b[Eb.Hf]); b.hasOwnProperty(Eb.Ff) && !1 === a && (a = b[Eb.Ff]); return a } }; var Qc = function (a) { return Pc ? F.querySelectorAll(a) : null }, Rc = function (a, b) {
        if (!Pc) return null; if (Element.prototype.closest) try { return a.closest(b) } catch (e) { return null } var c = Element.prototype.matches || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector, d = a; if (!F.documentElement.contains(d)) return null; do { try { if (c.call(d, b)) return d } catch (e) { break } d = d.parentElement || d.parentNode } while (null !== d && 1 === d.nodeType);
        return null
    }, Sc = !1; if (F.querySelectorAll) try { var Tc = F.querySelectorAll(":root"); Tc && 1 == Tc.length && Tc[0] == F.documentElement && (Sc = !0) } catch (a) { } var Pc = Sc; var Uc = []; Uc[7] = !0; Uc[9] = !0; Uc[27] = !0;
    Uc[5] = !0; Uc[6] = !0; Uc[11] = !0; Uc[15] = !0;
    Uc[18] = !0; Uc[19] = !0;
    Uc[24] = !0;
    ...
    function Vc(a, b) { for (var c, d, e = 0; c === d;)if (c = Math.floor(2 * Math.random()), d = Math.floor(2 * Math.random()), e++, 20 < e) return; c ? Uc[a] = !0 : Uc[b] = !0 } var Wc = function (a) { return !!Uc[a] }; var O = function (a) { db("GTM", a) }; var R = {
        g: {
            F: "ad_storage", U: "analytics_storage", Bf: "region", Cf: "consent_updated", Df: "wait_for_update", Lh: "app_remove", Mh: "app_store_refund", Nh: "app_store_subscription_cancel", Oh: "app_store_subscription_convert", Ph: "app_store_subscription_renew", Jf: "add_payment_info", Kf: "add_shipping_info", kc: "add_to_cart", mc: "remove_from_cart", Lf: "view_cart", Ib: "begin_checkout", nc: "select_item", rb: "view_item_list", Jb: "select_promotion", sb: "view_promotion", Ba: "purchase", oc: "refund", Ha: "view_item", Mf: "add_to_wishlist",
            ...
            Ne: "user_data_settings", sa: "user_id", Ma: "user_properties", Cg: "us_privacy_string", ka: "value", Nd: "wbraid", Dg: "wbraid_multiple_conversions", Gg: "_host_name", Hg: "_in_page_command", Ig: "_is_linker_valid", Jg: "_is_passthrough_cid", Lg: "non_personalized_ads"
        }
    }, wd = {}, xd = Object.freeze((wd[R.g.X] = 1, wd[R.g.sc] = 1, wd[R.g.uc] = 1, wd[R.g.Z] = 1, wd[R.g.Xa] = 1, wd[R.g.Ia] = 1, wd[R.g.Ya] = 1, wd[R.g.Bc] = 1, wd[R.g.we] = 1, wd[R.g.Pa] = 1, wd[R.g.tb] = 1, wd[R.g.Dc] = 1, wd[R.g.aa] = 1, wd[R.g.xe] = 1, wd[R.g.Mb] = 1, wd[R.g.Bd] = 1, wd[R.g.Cd] = 1, wd[R.g.Dd] =
    ...
    var yd = {}, zd = Object.freeze((yd[R.g.Lh] = 1, yd[R.g.Mh] = 1, yd[R.g.Nh] = 1, yd[R.g.Oh] = 1, yd[R.g.Ph] = 1, yd[R.g.Qh] = 1, yd[R.g.Rh] = 1, yd[R.g.Sh] = 1, yd[R.g.Th] = 1, yd[R.g.te] = 1, yd)), Ad = {}, Bd = Object.freeze((Ad[R.g.Jf] = 1, Ad[R.g.Kf] = 1, Ad[R.g.kc] = 1, Ad[R.g.mc] = 1, Ad[R.g.Lf] = 1, Ad[R.g.Ib] = 1, Ad[R.g.nc] = 1, Ad[R.g.rb] = 1, Ad[R.g.Jb] = 1, Ad[R.g.sb] = 1, Ad[R.g.Ba] = 1, Ad[R.g.oc] = 1, Ad[R.g.Ha] = 1, Ad[R.g.Mf] = 1, Ad)), Cd = Object.freeze([R.g.X, R.g.uc, R.g.tb]), Dd = Object.freeze([].concat(Cd)), Ed = Object.freeze([R.g.Ia, R.g.Cd, R.g.Kc, R.g.Ee, R.g.Ad]),
        Fd = Object.freeze([].concat(Ed)), Gd = {}, Hd = (Gd[R.g.F] = "1", Gd[R.g.U] = "2", Gd), Jd = {}, Kd = Object.freeze((Jd[R.g.X] = 1, Jd[R.g.sc] = 1, Jd[R.g.wa] = 1, Jd[R.g.Va] = 1, Jd[R.g.sd] = 1, Jd[R.g.vc] = 1, Jd[R.g.wc] = 1, Jd[R.g.xc] = 1, Jd[R.g.Z] = 1, Jd[R.g.yc] = 1, Jd[R.g.Da] = 1, Jd[R.g.qa] = 1, Jd[R.g.Xa] = 1, Jd[R.g.Ia] = 1, Jd[R.g.Ya] = 1, Jd[R.g.Pa] = 1, Jd[R.g.ma] = 1, Jd[R.g.Cc] = 1, Jd[R.g.aa] = 1, Jd[R.g.Of] = 1, Jd[R.g.Gc] = 1, Jd[R.g.Hc] = 1, Jd[R.g.ze] = 1, Jd[R.g.Dd] = 1, Jd[R.g.Ja] = 1, Jd[R.g.Rb] = 1, Jd[R.g.Ka] = 1, Jd[R.g.La] = 1, Jd[R.g.kg] = 1, Jd[R.g.lg] = 1, Jd[R.g.mg] = 1, Jd[R.g.ng] =
            1, Jd[R.g.lb] = 1, Jd[R.g.xa] = 1, Jd[R.g.wb] = 1, Jd[R.g.Tb] = 1, Jd[R.g.Ea] = 1, Jd[R.g.na] = 1, Jd[R.g.Lc] = 1, Jd[R.g.ab] = 1, Jd[R.g.ca] = 1, Jd[R.g.sa] = 1, Jd[R.g.ka] = 1, Jd)); Object.freeze(R.g); var Ld = {}, Md = E.google_tag_manager = E.google_tag_manager || {}, Nd = Math.random(); Ld.Sd = "aa0"; Ld.jk = Number("") || 0; Ld.fa = "dataLayer"; Ld.Kh = "ChEI8KiUmgYQk8PTp4Hr1v3/ARIoAP0HAQDUsmcvZL6Ic6ewHGxPGWadOvf0Mhf/GfXYFJeVzthxyMaFJRoC6Ew\x3d"; var Od = { __cl: !0, __ecl: !0, __ehl: !0, __evl: !0, __fal: !0, __fil: !0, __fsl: !0, __hl: !0, __jel: !0, __lcl: !0, __sdl: !0, __tl: !0, __ytl: !0 }, Pd = { __paused: !0, __tg: !0 }, Qd; for (Qd in Od) Od.hasOwnProperty(Qd) && (Pd[Qd] = !0); var Rd = Aa(""), Sd = Aa(""), Td, Ud = !1;
    Ud = !0; Td = Ud; var Vd, Wd = !1; Vd = Wd; var Xd, Yd = !1; Xd = Yd; var Zd, $d = !1; Zd = $d; Ld.qd = "www.googletagmanager.com";
    var ae = "" + Ld.qd + (Td ? "/gtag/js" : "/gtm.js"), be = null, ce = null, de = {}, ee = {}, fe = function () { var a = Md.sequence || 1; Md.sequence = a + 1; return a }; Ld.Jh = ""; var ge = ""; Ld.Td = ge; var he = new ta, ie = {}, je = {}, me = { name: Ld.fa, set: function (a, b) { N(Ja(a, b), ie); ke() }, get: function (a) { return le(a, 2) }, reset: function () { he = new ta; ie = {}; ke() } }, le = function (a, b) { return 2 != b ? he.get(a) : ne(a) }, ne = function (a) { var b, c = a.split("."); b = b || []; for (var d = ie, e = 0; e < c.length; e++) { if (null === d) return !1; if (void 0 === d) break; d = d[c[e]]; if (-1 !== b.indexOf(d)) return } return d }, oe = function (a, b) { je.hasOwnProperty(a) || (he.set(a, b), N(Ja(a, b), ie), ke()) }, ke = function (a) {
        k(je, function (b, c) {
            he.set(b, c); N(Ja(b), ie); N(Ja(b,
                c), ie); a && delete je[b]
        })
    }, pe = function (a, b) { var c, d = 1 !== (void 0 === b ? 2 : b) ? ne(a) : he.get(a); "array" === Bb(d) || "object" === Bb(d) ? c = N(d) : c = d; return c }; var qe, re = !1, se = function (a) { if (!re) { re = !0; qe = qe || {} } return qe[a] }; var te = function () { var a = E.screen; return { width: a ? a.width : 0, height: a ? a.height : 0 } }, ue = function (a) {
        if (F.hidden) return !0; var b = a.getBoundingClientRect(); if (b.top == b.bottom || b.left == b.right || !E.getComputedStyle) return !0; var c = E.getComputedStyle(a, null); if ("hidden" === c.visibility) return !0; for (var d = a, e = c; d;) {
            if ("none" === e.display) return !0; var f = e.opacity, g = e.filter; if (g) {
                var l = g.indexOf("opacity("); 0 <= l && (g = g.substring(l + 8, g.indexOf(")", l)), "%" == g.charAt(g.length - 1) && (g = g.substring(0, g.length - 1)), f = Math.min(g,
                    f))
            } if (void 0 !== f && 0 >= f) return !0; (d = d.parentElement) && (e = E.getComputedStyle(d, null))
        } return !1
    }; var Fe = /:[0-9]+$/, Ge = function (a, b, c) { for (var d = a.split("&"), e = 0; e < d.length; e++) { var f = d[e].split("="); if (decodeURIComponent(f[0]).replace(/\+/g, " ") === b) { var g = f.slice(1).join("="); return c ? g : decodeURIComponent(g).replace(/\+/g, " ") } } }, Je = function (a, b, c, d, e) {
        b && (b = String(b).toLowerCase()); if ("protocol" === b || "port" === b) a.protocol = He(a.protocol) || He(E.location.protocol); "port" === b ? a.port = String(Number(a.hostname ? a.port : E.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" ===
            b && (a.hostname = (a.hostname || E.location.hostname).replace(Fe, "").toLowerCase()); return Ie(a, b, c, d, e)
    }, Ie = function (a, b, c, d, e) {
        var f, g = He(a.protocol); b && (b = String(b).toLowerCase()); switch (b) {
            case "url_no_fragment": f = Ke(a); break; case "protocol": f = g; break; case "host": f = a.hostname.replace(Fe, "").toLowerCase(); if (c) { var l = /^www\d*\./.exec(f); l && l[0] && (f = f.substr(l[0].length)) } break; case "port": f = String(Number(a.port) || ("http" === g ? 80 : "https" === g ? 443 : "")); break; case "path": a.pathname || a.hostname || db("TAGGING",
                1); f = "/" === a.pathname.substr(0, 1) ? a.pathname : "/" + a.pathname; var m = f.split("/"); 0 <= (d || []).indexOf(m[m.length - 1]) && (m[m.length - 1] = ""); f = m.join("/"); break; case "query": f = a.search.replace("?", ""); e && (f = Ge(f, e)); break; case "extension": var n = a.pathname.split("."); f = 1 < n.length ? n[n.length - 1] : ""; f = f.split("/")[0]; break; case "fragment": f = a.hash.replace("#", ""); break; default: f = a && a.href
        }return f
    ...
    }, Le = function (a) { var b = F.createElement("a"); a && (b.href = a); var c = b.pathname; "/" !== c[0] && (a || db("TAGGING", 1), c = "/" + c); var d = b.hostname.replace(Fe, ""); return { href: b.href, protocol: b.protocol, host: b.host, hostname: d, pathname: c, search: b.search, hash: b.hash, port: b.port } }, Me = function (a) {
        function b(n) { var p = n.split("=")[0]; return 0 > d.indexOf(p) ? n : p + "=0" } function c(n) { return n.split("&").map(b).filter(function (p) { return void 0 !== p }).join("&") } var d = "gclid dclid gbraid wbraid gclaw gcldc gclha gclgf gclgb _gl".split(" "),
            e = Le(a), f = a.split(/[?#]/)[0], g = e.search, l = e.hash; "?" === g[0] && (g = g.substring(1)); "#" === l[0] && (l = l.substring(1)); g = c(g); l = c(l); "" !== g && (g = "?" + g); "" !== l && (l = "#" + l); var m = "" + f + g + l; "/" === m[m.length - 1] && (m = m.substring(0, m.length - 1)); return m
    }; var Ne = {}; var pf = {}, qf = function (a, b) { if (E._gtmexpgrp && E._gtmexpgrp.hasOwnProperty(a)) return E._gtmexpgrp[a]; void 0 === pf[a] && (pf[a] = Math.floor(Math.random() * b)); return pf[a] }; var sf = { Zg: "TH", Kj: "TH-77" }; var tf = new function (a, b) { this.h = a; this.defaultValue = void 0 === b ? !1 : b }(1933); var uf = function (a) { uf[" "](a); return a }; uf[" "] = function () { }; var wf = function () { var a = vf, b = "cf"; if (a.cf && a.hasOwnProperty(b)) return a.cf; var c = new a; return a.cf = c }; var vf = function () { var a = {}; this.h = function () { var b = tf.h, c = tf.defaultValue; return null != a[b] ? a[b] : c }; this.m = function () { a[tf.h] = !0 } }; var xf = []; function yf() { var a = ib("google_tag_data", {}); a.ics || (a.ics = { entries: {}, set: zf, update: Af, addListener: Bf, notifyListeners: Cf, active: !1, usedDefault: !1, usedUpdate: !1, accessedDefault: !1, accessedAny: !1, wasSetLate: !1 }); return a.ics }
    function zf(a, b, c, d, e, f) {
        var g = yf(); g.usedDefault || !g.accessedDefault && !g.accessedAny || (g.wasSetLate = !0); g.active = !0; g.usedDefault = !0; if (void 0 != b) {
            var l = g.entries, m = l[a] || {}, n = m.region, p = c && h(c) ? c.toUpperCase() : void 0; d = d.toUpperCase(); e = e.toUpperCase(); if ("" === d || p === e || (p === d ? n !== e : !p && !n)) {
                var q = !!(f && 0 < f && void 0 === m.update), t = { region: p, initial: "granted" === b, update: m.update, quiet: q }; if ("" !== d || !1 !== m.initial) l[a] = t; q && E.setTimeout(function () {
                    l[a] === t && t.quiet && (t.quiet = !1, Df(a), Cf(), db("TAGGING",
                        2))
                }, f)
            }
        }
    } function Af(a, b) { var c = yf(); c.usedDefault || c.usedUpdate || !c.accessedAny || (c.wasSetLate = !0); c.active = !0; c.usedUpdate = !0; if (void 0 != b) { var d = Ef(c, a), e = c.entries, f = e[a] = e[a] || {}; f.update = "granted" === b; var g = Ef(c, a); f.quiet ? (f.quiet = !1, Df(a)) : g !== d && Df(a) } } function Bf(a, b) { xf.push({ Ve: a, Wi: b }) } function Df(a) { for (var b = 0; b < xf.length; ++b) { var c = xf[b]; qa(c.Ve) && -1 !== c.Ve.indexOf(a) && (c.qh = !0) } }
    ...
    var ng = function (a, b, c) {
        function d(u, r, v) { if (null == v) return delete g[r], u; g[r] = v; return u + "; " + r + "=" + v } function e(u, r) { if (null == r) return delete g[r], u; g[r] = !0; return u + "; " + r } if (!dg(c.qb)) return 2; var f; void 0 == b ? f = a + "=deleted; expires=" + (new Date(0)).toUTCString() : (c.encode && (b = encodeURIComponent(b)), b = kg(b), f = a + "=" + b); var g = {}; f = d(f, "path", c.path); var l; c.expires instanceof Date ? l = c.expires.toUTCString() : null != c.expires && (l = "" + c.expires); f = d(f, "expires", l); f = d(f, "max-age", c.mk); f = d(f, "samesite",
            c.nk); c.pk && (f = e(f, "secure")); var m = c.domain; if (m && "auto" === m.toLowerCase()) { for (var n = lg(), p = 0; p < n.length; ++p) { var q = "none" !== n[p] ? n[p] : void 0, t = d(f, "domain", q); t = e(t, c.flags); if (!mg(q, c.path) && jg(t, a, b, c.qb)) return 0 } return 1 } m && "none" !== m.toLowerCase() && (f = d(f, "domain", m)); f = e(f, c.flags); return mg(m, c.path) ? 1 : jg(f, a, b, c.qb) ? 0 : 1
    }, og = function (a, b, c) { null == c.path && (c.path = "/"); c.domain || (c.domain = "auto"); return ng(a, b, c) };
    ...
    var kg = function (a) { a && 1200 < a.length && (a = a.substring(0, 1200)); return a }, wg = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, xg = /(^|\.)doubleclick\.net$/i, mg = function (a, b) { return xg.test(window.document.location.hostname) || "/" === b && wg.test(a) }, eg = function () { return cg(window) ? window.document.cookie : "" }, lg = function () {
    ...
    }, kh = function (a) { a.B || (a.B = function (b) { try { var c; c = ("string" === typeof b.data ? JSON.parse(b.data) : b.data).__tcfapiReturn; a.K[c.callId](c.returnValue, c.success) } catch (d) { } }, Tg(a.m, a.B)) }; var lh = !0; lh = !1; var mh = { 1: 0, 3: 0, 4: 0, 7: 3, 9: 3, 10: 3 }, nh = Sg("", 550), oh = Sg("", 500); function ph() { var a = Md.tcf || {}; return Md.tcf = a }
    var uh = function () {
        var a = ph(), b = new fh(E, lh ? 3E3 : -1); if (!0 === E.gtag_enable_tcf_support && !a.active && ("function" === typeof E.__tcfapi || "function" === typeof b.m.__tcfapi || null != jh(b))) {
            a.active = !0; a.ed = {}; qh(); var c = null; lh ? c = E.setTimeout(function () { rh(a); sh(a); c = null }, oh) : a.tcString = "tcunavailable"; try {
                b.addEventListener(function (d) {
                    c && (clearTimeout(c), c = null); if (0 !== d.internalErrorState) rh(a), sh(a); else {
                        var e; a.gdprApplies = d.gdprApplies; if (!1 === d.gdprApplies) e = th(), b.removeEventListener(d); else if ("tcloaded" ===
                            d.eventStatus || "useractioncomplete" === d.eventStatus || "cmpuishown" === d.eventStatus) {
                            var f = {}, g; for (g in mh) if (mh.hasOwnProperty(g)) if ("1" === g) {
                                var l = d, m = !0; m = void 0 === m ? !1 : m; var n; var p = l; !1 === p.gdprApplies ? n = !0 : (void 0 === p.internalErrorState && (p.internalErrorState = eh(p)), n = "error" === p.cmpStatus || 0 !== p.internalErrorState ? !p.internalBlockOnErrors : "loaded" !== p.cmpStatus || "tcloaded" !== p.eventStatus && "useractioncomplete" !== p.eventStatus ? !1 : !0); f["1"] = n ? !1 === l.gdprApplies || "tcunavailable" === l.tcString ||
                                    void 0 === l.gdprApplies && !m || "string" !== typeof l.tcString || !l.tcString.length ? !0 : ih(l, "1", 0) : !1
                            } else f[g] = ih(d, g, mh[g]); e = f
                        } e && (a.tcString = d.tcString || "tcempty", a.ed = e, sh(a))
                    }
                })
            } catch (d) { c && (clearTimeout(c), c = null), rh(a), sh(a) }
        }
    }; function rh(a) { a.type = "e"; a.tcString = "tcunavailable"; lh && (a.ed = th()) } function qh() { var a = {}, b = (a.ad_storage = "denied", a.wait_for_update = nh, a); Sf(b) } function th() { var a = {}, b; for (b in mh) mh.hasOwnProperty(b) && (a[b] = !0); return a }
    ...
    var ci = function (a, b) { b || (b = "_gl"); var c = Wh.exec(a); if (!c) return ""; var d = c[1], e = bi(b, (c[2] || "").slice(1)), f = bi(b, (c[3] || "").slice(1)); e.length && (e = "?" + e); f.length && (f = "#" + f); return "" + d + e + f }, di = function (a) { var b = $h(), c = Ph(); c.data || (c.data = { query: {}, fragment: {} }, b(c.data)); var d = {}, e = c.data; e && (Ga(d, e.query), a && Ga(d, e.fragment)); return d }, ai = function (a) {
        try { var b = ei(a, 3); if (void 0 !== b) { for (var c = {}, d = b ? b.split("*") : [], e = 0; e + 1 < d.length; e += 2) { var f = d[e], g = Lh(d[e + 1]); c[f] = g } db("TAGGING", 6); return c } } catch (l) {
            db("TAGGING",
                8)
        }
    }; function ei(a, b) { if (a) { var c; a: { for (var d = a, e = 0; 3 > e; ++e) { var f = Th.exec(d); if (f) { c = f; break a } d = decodeURIComponent(d) } c = void 0 } var g = c; if (g && "1" === g[1]) { var l = g[3], m; a: { for (var n = g[2], p = 0; p < b; ++p)if (n === Yh(l, p)) { m = !0; break a } m = !1 } if (m) return l; db("TAGGING", 7) } } }
    ...
    var ji = function (a, b, c, d) { Qh(); Rh(a, b, "fragment" === c ? 2 : 1, !!d, !1) }, ki = function (a, b) { Qh(); Rh(a, [Ie(E.location, "host", !0)], b, !0, !0) }, li = function () {
        var a = F.location.hostname, b = Uh.exec(F.referrer); if (!b) return !1; var c = b[2], d = b[1], e = ""; if (c) { var f = c.split("/"), g = f[1]; e = "s" === g ? decodeURIComponent(f[2]) : decodeURIComponent(g) } else if (d) { if (0 === d.indexOf("xn--")) return !1; e = d.replace(/-/g, ".").replace(/\.\./g, "-") } var l = a.replace(Vh, ""), m = e.replace(Vh, ""), n; if (!(n = l === m)) {
            var p = "." + m; n = l.substring(l.length - p.length,
                l.length) === p
        } return n
    }, mi = function (a, b) { return !1 === a ? !1 : a || b || li() }; var ni = {}; var oi = function (a) { for (var b = [], c = F.cookie.split(";"), d = new RegExp("^\\s*" + (a || "_gac") + "_(UA-\\d+-\\d+)=\\s*(.+?)\\s*$"), e = 0; e < c.length; e++) { var f = c[e].match(d); f && b.push({ xf: f[1], value: f[2], timestamp: Number(f[2].split(".")[1]) || 0 }) } b.sort(function (g, l) { return l.timestamp - g.timestamp }); return b };
    function pi(a, b) { var c = oi(a), d = {}; if (!c || !c.length) return d; for (var e = 0; e < c.length; e++) { var f = c[e].value.split("."); if (!("1" !== f[0] || b && 3 > f.length || !b && 3 !== f.length) && Number(f[1])) { d[c[e].xf] || (d[c[e].xf] = []); var g = { version: f[0], timestamp: 1E3 * Number(f[1]), da: f[2] }; b && 3 < f.length && (g.labels = f.slice(3)); d[c[e].xf].push(g) } } return d }; var qi = /^\w+$/, ri = /^[\w-]+$/, si = { aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp", gb: "_gb" }, ti = function () { if (!wf().h() || !If()) return !0; var a = Ff("ad_storage"); return null == a ? !0 : !!a }, ui = function (a, b) { Hf("ad_storage") ? ti() ? a() : Nf(a, "ad_storage") : b ? db("TAGGING", 3) : Mf(function () { ui(a, !0) }, ["ad_storage"]) }, wi = function (a) { return vi(a).map(function (b) { return b.da }) }, vi = function (a) {
        var b = []; if (!cg(E) || !F.cookie) return b; var c = fg(a, F.cookie, void 0, "ad_storage"); if (!c || 0 == c.length) return b; for (var d = {}, e = 0; e < c.length; d =
            { ld: d.ld }, e++) { var f = xi(c[e]); if (null != f) { var g = f, l = g.version; d.ld = g.da; var m = g.timestamp, n = g.labels, p = ra(b, function (q) { return function (t) { return t.da === q.ld } }(d)); p ? (p.timestamp = Math.max(p.timestamp, m), p.labels = yi(p.labels, n || [])) : b.push({ version: l, da: d.ld, timestamp: m, labels: n }) } } b.sort(function (q, t) { return t.timestamp - q.timestamp }); return zi(b)
    }; function yi(a, b) { for (var c = {}, d = [], e = 0; e < a.length; e++)c[a[e]] = !0, d.push(a[e]); for (var f = 0; f < b.length; f++)c[b[f]] || d.push(b[f]); return d }
    function Ai(a) { return a && "string" == typeof a && a.match(qi) ? a : "_gcl" }
    var Ci = function () { var a = Le(E.location.href), b = Je(a, "query", !1, void 0, "gclid"), c = Je(a, "query", !1, void 0, "gclsrc"), d = Je(a, "query", !1, void 0, "wbraid"), e = Je(a, "query", !1, void 0, "dclid"); if (!b || !c || !d) { var f = a.hash.replace("#", ""); b = b || Ge(f, "gclid"); c = c || Ge(f, "gclsrc"); d = d || Ge(f, "wbraid") } return Bi(b, c, e, d) }, Bi = function (a, b, c, d) {
        var e = {}, f = function (g, l) { e[l] || (e[l] = []); e[l].push(g) }; e.gclid = a; e.gclsrc = b; e.dclid = c; void 0 !== d && ri.test(d) && (e.gbraid = d, f(d, "gb")); if (void 0 !== a && a.match(ri)) switch (b) {
            case void 0: f(a,
                "aw"); break; case "aw.ds": f(a, "aw"); f(a, "dc"); break; case "ds": f(a, "dc"); break; case "3p.ds": f(a, "dc"); break; case "gf": f(a, "gf"); break; case "ha": f(a, "ha")
        }c && f(c, "dc"); return e
    }, Ei = function (a) { var b = Ci(); ui(function () { Di(b, !1, a) }) };
    function Di(a, b, c, d, e) {
        function f(w, y) { var x = Fi(w, g); x && (og(x, y, l), m = !0) } c = c || {}; e = e || []; var g = Ai(c.prefix); d = d || z(); var l = yh(c, d, !0); l.qb = "ad_storage"; var m = !1, n = Math.round(d / 1E3), p = function (w) { var y = ["GCL", n, w]; 0 < e.length && y.push(e.join(".")); return y.join(".") }; a.aw && f("aw", p(a.aw[0])); a.dc && f("dc", p(a.dc[0])); a.gf && f("gf", p(a.gf[0])); a.ha && f("ha", p(a.ha[0])); a.gp && f("gp", p(a.gp[0])); if ((void 0 == ni.enable_gbraid_cookie_write ? 0 : ni.enable_gbraid_cookie_write) && !m && a.gb) {
            var q = a.gb[0], t = Fi("gb", g),
                u = !1; if (!b) for (var r = vi(t), v = 0; v < r.length; v++)r[v].da === q && r[v].labels && 0 < r[v].labels.length && (u = !0); u || f("gb", p(q))
        }
    }
    var Hi = function (a, b) { var c = di(!0); ui(function () { for (var d = Ai(b.prefix), e = 0; e < a.length; ++e) { var f = a[e]; if (void 0 !== si[f]) { var g = Fi(f, d), l = c[g]; if (l) { var m = Math.min(Gi(l), z()), n; b: { var p = m; if (cg(E)) for (var q = fg(g, F.cookie, void 0, "ad_storage"), t = 0; t < q.length; ++t)if (Gi(q[t]) > p) { n = !0; break b } n = !1 } if (!n) { var u = yh(b, m, !0); u.qb = "ad_storage"; og(g, l, u) } } } } Di(Bi(c.gclid, c.gclsrc), !1, b) }) }, Fi = function (a, b) { var c = si[a]; if (void 0 !== c) return b + c }, Gi = function (a) {
        return 0 !== Ii(a.split(".")).length ? 1E3 * (Number(a.split(".")[1]) ||
            0) : 0
    }; function xi(a) { var b = Ii(a.split(".")); return 0 === b.length ? null : { version: b[0], da: b[2], timestamp: 1E3 * (Number(b[1]) || 0), labels: b.slice(3) } } function Ii(a) { return 3 > a.length || "GCL" !== a[0] && "1" !== a[0] || !/^\d+$/.test(a[1]) || !ri.test(a[2]) ? [] : a }
    var Ji = function (a, b, c, d, e) { if (qa(b) && cg(E)) { var f = Ai(e), g = function () { for (var l = {}, m = 0; m < a.length; ++m) { var n = Fi(a[m], f); if (n) { var p = fg(n, F.cookie, void 0, "ad_storage"); p.length && (l[n] = p.sort()[p.length - 1]) } } return l }; ui(function () { ji(g, b, c, d) }) } }, zi = function (a) { return a.filter(function (b) { return ri.test(b.da) }) }, Ki = function (a, b) {
        if (cg(E)) {
            for (var c = Ai(b.prefix), d = {}, e = 0; e < a.length; e++)si[a[e]] && (d[a[e]] = si[a[e]]); ui(function () {
                k(d, function (f, g) {
                    var l = fg(c + g, F.cookie, void 0, "ad_storage"); l.sort(function (u,
                        r) { return Gi(r) - Gi(u) }); if (l.length) { var m = l[0], n = Gi(m), p = 0 !== Ii(m.split(".")).length ? m.split(".").slice(3) : [], q = {}, t; t = 0 !== Ii(m.split(".")).length ? m.split(".")[2] : void 0; q[f] = [t]; Di(q, !0, b, n, p) }
                })
            })
        }
    }; function Li(a, b) { for (var c = 0; c < b.length; ++c)if (a[b[c]]) return !0; return !1 }
    var Mi = function (a) { function b(e, f, g) { g && (e[f] = g) } if (If()) { var c = Ci(); if (Li(c, a)) { var d = {}; b(d, "gclid", c.gclid); b(d, "dclid", c.dclid); b(d, "gclsrc", c.gclsrc); b(d, "wbraid", c.gbraid); ki(function () { return d }, 3); ki(function () { var e = {}; return e._up = "1", e }, 1) } } }, Ni = function (a, b, c, d) {
        var e = []; c = c || {}; if (!ti()) return e; var f = vi(a); if (!f.length) return e; for (var g = 0; g < f.length; g++)-1 === (f[g].labels || []).indexOf(b) ? e.push(0) : e.push(1); if (d) return e; if (1 !== e[0]) {
            var l = f[0], m = f[0].timestamp, n = [l.version, Math.round(m /
                1E3), l.da].concat(l.labels || [], [b]).join("."), p = yh(c, m, !0); p.qb = "ad_storage"; og(a, n, p)
        } return e
    }; function Oi(a, b) { var c = Ai(b), d = Fi(a, c); if (!d) return 0; for (var e = vi(d), f = 0, g = 0; g < e.length; g++)f = Math.max(f, e[g].timestamp); return f } function Pi(a) { var b = 0, c; for (c in a) for (var d = a[c], e = 0; e < d.length; e++)b = Math.max(b, Number(d[e].timestamp)); return b } var Qi = function (a) { var b = Math.max(Oi("aw", a), Pi(ti() ? pi() : {})); return Math.max(Oi("gb", a), Pi(ti() ? pi("_gac_gb", !0) : {})) > b }; var Vi = /[A-Z]+/, Wi = /\s/, Xi = function (a) { if (h(a)) { a = Ca(a); var b = a.indexOf("-"); if (!(0 > b)) { var c = a.substring(0, b); if (Vi.test(c)) { for (var d = a.substring(b + 1).split("/"), e = 0; e < d.length; e++)if (!d[e] || Wi.test(d[e]) && ("AW" !== c || 1 !== e)) return; return { id: a, prefix: c, T: c + "-" + d[0], I: d } } } } }, Zi = function (a) { for (var b = {}, c = 0; c < a.length; ++c) { var d = Xi(a[c]); d && (b[d.id] = d) } Yi(b); var e = []; k(b, function (f, g) { e.push(g) }); return e };
    ...
    var cj = function (a, b, c) { if (E[a.functionName]) return b.pf && G(b.pf), E[a.functionName]; var d = bj(); E[a.functionName] = d; if (a.Vd) for (var e = 0; e < a.Vd.length; e++)E[a.Vd[e]] = E[a.Vd[e]] || bj(); a.je && void 0 === E[a.je] && (E[a.je] = c); nb(aj("https://", "http://", a.wf), b.pf, b.zj); return d }, bj = function () { var a = function () { a.q = a.q || []; a.q.push(arguments) }; return a }, dj = { functionName: "_googWcmImpl", je: "_googWcmAk", wf: "www.gstatic.com/wcm/loader.js" }, ej = { functionName: "_gaPhoneImpl", je: "ga_wpid", wf: "www.gstatic.com/gaphone/loader.js" },
        fj = { Hh: "", Bi: "5" }, gj = { functionName: "_googCallTrackingImpl", Vd: [ej.functionName, dj.functionName], wf: "www.gstatic.com/call-tracking/call-tracking_" + (fj.Hh || fj.Bi) + ".js" }, hj = {}, ij = function (a, b, c, d) { O(22); if (c) { d = d || {}; var e = cj(dj, d, a), f = { ak: a, cl: b }; void 0 === d.eb && (f.autoreplace = c); e(2, d.eb, f, c, 0, Da(), d.options) } }, jj = function (a, b, c, d) {
            O(21); if (b && c) {
                d = d || {}; for (var e = { countryNameCode: c, destinationNumber: b, retrievalTime: Da() }, f = 0; f < a.length; f++) {
                    var g = a[f]; hj[g.id] ||
                        (g && "AW" === g.prefix && !e.adData && 2 <= g.I.length ? (e.adData = { ak: g.I[0], cl: g.I[1] }, hj[g.id] = !0) : g && "UA" === g.prefix && !e.gaData && (e.gaData = { gaWpid: g.T }, hj[g.id] = !0))
                } (e.gaData || e.adData) && cj(gj, d)(d.eb, e, d.options)
            }
        }, kj = function () { var a = !1; return a }, Aj = function (a, b) {
            if (a) if (Fg()) { } else {
                if (h(a)) {
                    var c =
                        Xi(a); if (!c) return; a = c
                } var d = void 0, e = !1, f = U(b, R.g.hi); if (f && qa(f)) { d = []; for (var g = 0; g < f.length; g++) { var l = Xi(f[g]); l && (d.push(l), (a.id === l.id || a.id === a.T && a.T === l.T) && (e = !0)) } } if (!d || e) {
                    var m = U(b, R.g.mg), n; if (m) {
                        qa(m) ? n = m : n = [m]; var p = U(b, R.g.kg), q = U(b, R.g.lg), t = U(b, R.g.ng), u = U(b, R.g.gi), r = p || q, v = 1; "UA" !== a.prefix || d || (v = 5); for (var w = 0; w < n.length; w++)if (w < v) if (d) jj(d, n[w], u, { eb: r, options: t }); else if ("AW" === a.prefix && a.I[1]) kj() ? jj([a], n[w], u || "US", { eb: r, options: t }) : ij(a.I[0], a.I[1], n[w], { eb: r, options: t });
                        else if ("UA" === a.prefix) if (kj()) jj([a], n[w], u || "US", { eb: r }); else { var y = a.T, x = n[w], A = { eb: r }; O(23); if (x) { A = A || {}; var B = cj(ej, A, y), D = {}; void 0 !== A.eb ? D.receiver = A.eb : D.replace = x; D.ga_wpid = y; D.destination = x; B(2, Da(), D) } }
                    }
                }
            }
        }; var Bj = function (a, b, c) { this.target = a; this.eventName = b; this.h = c; this.m = {}; this.metadata = N(c.eventMetadata || {}); this.H = !1 }, Cj = function (a, b, c) { var d = U(a.h, b); void 0 !== d ? a.m[b] = d : void 0 !== c && (a.m[b] = c) }, Dj = function (a, b, c) { var d = se(a.target.T); return d && d.hasOwnProperty(b) ? d[b] : c }; function Ej(a) {
            return {
                getDestinationId: function () { return a.target.T }, getEventName: function () { return a.eventName }, setEventName: function (b) { return void (a.eventName = b) }, getHitData: function (b) { return a.m[b] }, setHitData: function (b, c) { return void (a.m[b] = c) }, setHitDataIfNotDefined: function (b, c) { void 0 === a.m[b] && (a.m[b] = c) }, copyToHitData: function (b, c) { Cj(a, b, c) }, getMetadata: function (b) { return a.metadata[b] }, setMetadata: function (b, c) { return void (a.metadata[b] = c) }, abort: function () { return void (a.H = !0) }, getProcessedEvent: function () { return a },
                getFromEventContext: function (b) { return U(a.h, b) }
            }
        }; var Xj = ["L", "S", "Y"], Yj = ["S", "E"], Zj = { sampleRate: "0.005000", Eh: "", Dh: Number("5") }, ak = 0 <= F.location.search.indexOf("?gtm_latency=") || 0 <= F.location.search.indexOf("&gtm_latency="), bk; if (!(bk = ak)) { var ck = Math.random(), dk = Zj.sampleRate; bk = ck < dk }
    ...
    function Gk(a) { }
    function Ek(a) { }
    var Yk = function (a, b, c) { if (ek && void 0 !== a && !yk[a]) { a !== wk && (Jk(), wk = a); var d = c + b; mk = mk ? mk + "." + d : "&epr=" + d; Mk(); Ok() } }, Zk = function (a, b, c) { }, $k = ["S", "P", "C", "Z"], al = {}, bl = (al[1] = 5, al[2] = 5, al[3] = 5, al), cl = {}, Lk = {}, Ik = void 0, dl = function (a, b) {
        var c = !1; if (!ek || Lk[a] || 0 === bl[b]) return !1; --bl[b]; Lk[a] = b; c = !0;
        return c
    }, el = function (a, b, c) { if (!ek || !Lk[a]) return; var d = cl[a]; d || (cl[a] = d = {}); d[b] = c; };
    ...
    var fl = function () { if (ek) { E.setInterval(jk, 864E5); rb(E, "pagehide", function () { wk && Lk[wk] && Jk(!0); for (var a in cl) cl.hasOwnProperty(a) && (wk = Number(a), Jk(!0)); }); } }; var gl = function (a, b, c, d, e, f, g, l, m, n, p, q) { this.eventId = a; this.priorityId = b; this.h = c; this.K = d; this.m = e; this.D = f; this.P = g; this.B = l; this.eventMetadata = m; this.O = n; this.N = p; this.C = q }, U = function (a, b, c) { if (void 0 !== a.h[b]) return a.h[b]; if (void 0 !== a.K[b]) return a.K[b]; if (void 0 !== a.m[b]) return a.m[b]; ek && hl(a, a.D[b], a.P[b]) && (O(71), O(79)); return void 0 !== a.D[b] ? a.D[b] : void 0 !== a.B[b] ? a.B[b] : c }, il = function (a) {
        function b(g) { for (var l = Object.keys(g), m = 0; m < l.length; ++m)c[l[m]] = 1 } var c = {}; b(a.h); b(a.K); b(a.m);
        b(a.D); if (ek) for (var d = Object.keys(a.P), e = 0; e < d.length; e++) { var f = d[e]; if ("event" !== f && "gtm" !== f && "tagTypeBlacklist" !== f && !c.hasOwnProperty(f)) { O(71); O(80); break } } return Object.keys(c)
    }, jl = function (a, b, c) { function d(m) { J(m) && k(m, function (n, p) { f = !0; e[n] = p }) } var e = {}, f = !1; c && 1 !== c || (d(a.B[b]), d(a.D[b]), d(a.m[b]), d(a.K[b])); c && 2 !== c || d(a.h[b]); if (ek) { var g = f, l = e; e = {}; f = !1; c && 1 !== c || (d(a.B[b]), d(a.P[b]), d(a.m[b]), d(a.K[b])); c && 2 !== c || d(a.h[b]); if (f !== g || hl(a, e, l)) O(71), O(81); f = g; e = l } return f ? e : void 0 },
        kl = function (a) { var b = [R.g.zc, R.g.ud, R.g.vd, R.g.wd, R.g.xd, R.g.yd, R.g.zd], c = {}, d = !1, e = function (l) { for (var m = 0; m < b.length; m++)void 0 !== l[b[m]] && (c[b[m]] = l[b[m]], d = !0); return d }; if (e(a.h) || e(a.K) || e(a.m)) return c; e(a.D); if (ek) { var f = c, g = d; c = {}; d = !1; e(a.P); hl(a, c, f) && (O(71), O(82)); c = f; d = g } if (d) return c; e(a.B); return c }, hl = function (a, b, c) {
            if (!ek) return !1; try {
                if (b === c) return !1; var d = Bb(b); if (d !== Bb(c) || !(J(b) && J(c) || "array" === d)) return !0; if ("array" === d) {
                    if (b.length !== c.length) return !0; for (var e = 0; e < b.length; e++)if (hl(a,
                        b[e], c[e])) return !0
                } else { for (var f in c) if (!b.hasOwnProperty(f)) return !0; for (var g in b) if (!c.hasOwnProperty(g) || hl(a, b[g], c[g])) return !0 }
            } catch (l) { O(72) } return !1
        }, ll = function (a, b) { this.ni = a; this.oi = b; this.D = {}; this.Eg = {}; this.h = {}; this.K = {}; this.m = {}; this.Mc = {}; this.B = {}; this.jc = function () { }; this.Ga = function () { }; this.P = !1 }, ml = function (a, b) { a.D = b; return a }, nl = function (a, b) { a.Eg = b; return a }, ol = function (a, b) { a.h = b; return a }, pl = function (a, b) { a.K = b; return a }, ql = function (a, b) { a.m = b; return a }, rl = function (a,
            b) { a.Mc = b; return a }, sl = function (a, b) { a.B = b || {}; return a }, tl = function (a, b) { a.jc = b; return a }, ul = function (a, b) { a.Ga = b; return a }, vl = function (a) { a.P = !0; return a }, wl = function (a) { return new gl(a.ni, a.oi, a.D, a.Eg, a.h, a.K, a.m, a.Mc, a.B, a.jc, a.Ga, a.P) }; Wa(); Ug() || Va("iPod"); Va("iPad"); !Va("Android") || Xa() || Wa() || Va("Opera") || Va("Silk"); Xa(); !Va("Safari") || Xa() || Va("Coast") || Va("Opera") || Va("Edge") || Va("Edg/") || Va("OPR") || Wa() || Va("Silk") || Va("Android") || Vg(); var Al = {}, Bl = null, Cl = function (a) {
                for (var b = [], c = 0, d = 0; d < a.length; d++) { var e = a.charCodeAt(d); 255 < e && (b[c++] = e & 255, e >>= 8); b[c++] = e } var f = 4; void 0 === f && (f = 0); if (!Bl) { Bl = {}; for (var g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), l = ["+/=", "+/", "-_=", "-_.", "-_"], m = 0; 5 > m; m++) { var n = g.concat(l[m].split("")); Al[m] = n; for (var p = 0; p < n.length; p++) { var q = n[p]; void 0 === Bl[q] && (Bl[q] = p) } } } for (var t = Al[f], u = Array(Math.floor(b.length / 3)), r = t[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
                    var y = b[v],
                        x = b[v + 1], A = b[v + 2], B = t[y >> 2], D = t[(y & 3) << 4 | x >> 4], H = t[(x & 15) << 2 | A >> 6], I = t[A & 63]; u[w++] = "" + B + D + H + I
                } var C = 0, K = r; switch (b.length - v) { case 2: C = b[v + 1], K = t[(C & 15) << 2] || r; case 1: var M = b[v]; u[w] = "" + t[M >> 2] + t[(M & 3) << 4 | C >> 4] + K + r }return u.join("")
            }; var Dl = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" "); function El() { var a; return null != (a = E.google_tag_data) ? a : E.google_tag_data = {} } function Fl() { var a = E.google_tag_data, b; if (null != a && a.uach) { var c = a.uach, d = Object.assign({}, c); c.fullVersionList && (d.fullVersionList = c.fullVersionList.slice(0)); b = d } else b = null; return b } function Gl() { var a, b; return null != (b = null == (a = E.google_tag_data) ? void 0 : a.uach_promise) ? b : null }
    ...
    var cm = function (a) { return bm(a, "_aw", Yl).map(function (b) { return b.da }).join(".") }, dm = function (a) { return bm(a, "_gb", Zl).map(function (b) { return b.da }).join(".") }, em = function (a, b) { var c = Ni((b && b.prefix || "_gcl") + "_gb", a, b); return 0 === c.length || c.every(function (d) { return 0 === d }) ? "" : c.join(".") }; var fm = function () { if (oa(E.__uspapi)) { var a = ""; try { E.__uspapi("getUSPData", 1, function (b, c) { if (c && b) { var d = b.uspString; d && RegExp("^[\\da-zA-Z-]{1,20}$").test(d) && (a = d) } }) } catch (b) { } return a } }; var Pm = function (a, b) { var c, d = E.GooglebQhCsO; d || (d = {}, E.GooglebQhCsO = d); c = d; if (c[a]) return !1; c[a] = []; c[a][0] = b; return !0 }; var Qm = function (a, b) { var c = Zg(a, "fmt"); if (b) { var d = Zg(a, "random"), e = Zg(a, "label") || ""; if (!d) return !1; var f = Cl(decodeURIComponent(e.replace(/\+/g, " ")) + ":" + decodeURIComponent(d.replace(/\+/g, " "))); if (!Pm(f, b)) return !1 } c && 4 != c && (a = ah(a, "rfmt", c)); var g = ah(a, "fmt", 4); nb(g, function () { E.google_noFurtherRedirects && b && b.call && (E.google_noFurtherRedirects = null, b()) }, void 0, void 0, F.getElementsByTagName("script")[0].parentElement || void 0); return !0 }; var fn = function () { this.h = {} }, gn = function (a, b, c) { null != c && (a.h[b] = c) }, hn = function (a) { return Object.keys(a.h).map(function (b) { return encodeURIComponent(b) + "=" + encodeURIComponent(a.h[b]) }).join("&") }, kn = function (a, b, c, d, e) { }; function mn(a, b) { if (a) { var c = "" + a; 0 !== c.indexOf("http://") && 0 !== c.indexOf("https://") && (c = "https://" + c); "/" === c[c.length - 1] && (c = c.substring(0, c.length - 1)); return Le("" + c + b).href } } function nn(a, b) { return Vd || Xd ? mn(a, b) : void 0 } function on() { return !!Ld.Td && "SGTM_TOKEN" !== Ld.Td.split("@@").join("") }; var qn = function (a, b, c, d) { if (!pn() && !Ng(a)) { var e = c ? "/gtag/js" : "/gtm.js", f = "?id=" + encodeURIComponent(a) + "&l=" + Ld.fa, g = 0 === a.indexOf("GTM-"); g || (f += "&cx=c"); var l = on(); l && (f += "&sign=" + Ld.Td); var m = nn(b, e + f); if (!m) { var n = Ld.qd + e; l && hb && g && (n = hb.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]); m = aj("https://", "http://", n + f) } Lg().container[a] = { state: 1, context: d }; nb(m) } }, rn = function (a, b, c) {
        var d; if (d = !pn()) { var e = Lg().destination[a]; d = !(e && e.state) } if (d) if (Og()) Lg().destination[a] = {
            state: 0, transportUrl: b,
            context: c
        }, O(91); else { var f = "/gtag/destination?id=" + encodeURIComponent(a) + "&l=" + Ld.fa + "&cx=c"; on() && (f += "&sign=" + Ld.Td); var g = nn(b, f); g || (g = aj("https://", "http://", Ld.qd + f)); Lg().destination[a] = { state: 1, context: c }; nb(g) }
    }; function pn() { if (Fg()) { return !0 } return !1 }; var sn = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/), tn = { cl: ["ecl"], customPixels: ["nonGooglePixels"], ecl: ["cl"], ehl: ["hl"], hl: ["ehl"], html: ["customScripts", "customPixels", "nonGooglePixels", "nonGoogleScripts", "nonGoogleIframes"], customScripts: ["html", "customPixels", "nonGooglePixels", "nonGoogleScripts", "nonGoogleIframes"], nonGooglePixels: [], nonGoogleScripts: ["nonGooglePixels"], nonGoogleIframes: ["nonGooglePixels"] }, un = {
    ...
    var wn = function () { var a = !1; a = !0; return a }, yn = function (a) {
        var b = le("gtm.allowlist") || le("gtm.whitelist"); b && O(9); wn() && (b = ["google", "gtagfl", "lcl", "zone"]); var c = b && Ia(Ba(b), tn), d = le("gtm.blocklist") ||
            le("gtm.blacklist"); d || (d = le("tagTypeBlacklist")) && O(3); d ? O(8) : d = []; xn() && (d = Ba(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts")); 0 <= Ba(d).indexOf("google") && O(2); var e = d && Ia(Ba(d), un), f = {}; return function (g) {
                var l = g && g[Eb.xb]; if (!l || "string" != typeof l) return !0; l = l.replace(/^_*/, ""); if (void 0 !== f[l]) return f[l]; var m = ee[l] || [], n = a(l, m); if (b) {
                    var p;
                    if (p = n) a: { if (0 > c.indexOf(l)) if (m && 0 < m.length) for (var q = 0; q < m.length; q++) { if (0 > c.indexOf(m[q])) { O(11); p = !1; break a } } else { p = !1; break a } p = !0 } n = p
                } var t = !1; if (d) { var u = 0 <= e.indexOf(l); if (u) t = u; else { var r = ua(e, m || []); r && O(10); t = r } } var v = !n || t; v || !(0 <= m.indexOf("sandboxedScripts")) || c && -1 !== c.indexOf("sandboxedScripts") || (v = ua(e, vn)); return f[l] = v
            }
    }, xn = function () { return sn.test(E.location && E.location.hostname) }; var zn = { initialized: 11, complete: 12, interactive: 13 }, An = {}, Bn = Object.freeze((An[R.g.xa] = !0, An)), Cn = 0 <= F.location.search.indexOf("?gtm_diagnostics=") || 0 <= F.location.search.indexOf("&gtm_diagnostics="), En = function (a, b, c) {
        if (ek && "config" === a && !(1 < Xi(b).I.length)) {
            var d, e = ib("google_tag_data", {}); e.td || (e.td = {}); d = e.td; var f = N(c.D); N(c.h, f); var g = [], l; for (l in d) { var m = Dn(d[l], f); m.length && (Cn && console.log(m), g.push(l)) } if (g.length) {
                if (g.length) { var n = b + "*" + g.join("."); ok = ok ? ok + "!" + n : "&tdc=" + n } db("TAGGING",
                    zn[F.readyState] || 14)
            } d[b] = f
        }
        ...
        b) { var c = Fa(function () { return G(function () { b(Gg.M, a.K) }) }); a.h ? c() : a.D.push(c) }, Tn = function (a) { a.B++; return Fa(function () { a.m++; a.P && a.m >= a.B && Rn(a) }) }, Un = function (a) { a.P = !0; a.m >= a.B && Rn(a) }; var Vn = function () { function a(d) { return !pa(d) || 0 > d ? 0 : d } if (!Md._li && E.performance && E.performance.timing) { var b = E.performance.timing.navigationStart, c = pa(me.get("gtm.start")) ? me.get("gtm.start") : 0; Md._li = { cst: a(c - b), cbt: a(ce - b) } } }, Wn = function (a) { E.performance && E.performance.mark(Gg.M + "_" + a + "_start") }, Xn = function (a) {
            if (E.performance) {
                var b = Gg.M + "_" + a + "_start", c = Gg.M + "_" + a + "_duration"; E.performance.measure(c, b); var d = E.performance.getEntriesByName(c)[0]; E.performance.clearMarks(b); E.performance.clearMeasures(c);
                var e = Md._p || {}; void 0 === e[a] && (e[a] = d.duration, Md._p = e); return d.duration
            }
        }, Yn = function () { var a = zb(); if (void 0 !== a) { var b = Md._p || {}; b.PAGEVIEW = a; Md._p = b } }; var Zn = {}, $n = function () { return E.GoogleAnalyticsObject && E[E.GoogleAnalyticsObject] }, ao = !1; var bo = function (a) { E.GoogleAnalyticsObject || (E.GoogleAnalyticsObject = a || "ga"); var b = E.GoogleAnalyticsObject; if (E[b]) E.hasOwnProperty(b) || O(12); else { var c = function () { c.q = c.q || []; c.q.push(arguments) }; c.l = Number(Da()); E[b] = c } Vn(); return E[b] }, co = function (a) { if (If()) { var b = $n(); b(a + "require", "linker"); b(a + "linker:passthrough", !0) } };
    function eo() { return E.GoogleAnalyticsObject || "ga" }
    var fo = function (a) { }, go = function (a, b) {
        return function () {
            var c = $n(), d = c && c.getByName && c.getByName(a); if (d) {
    ...
    }; function lo(a, b, c, d) { var e = ec[a], f = mo(a, b, c, d); if (!f) return null; var g = nc(e[Eb.Qg], c, []); if (g && g.length) { var l = g[0]; f = lo(l.index, { O: f, N: 1 === l.eh ? b.terminate : f, terminate: b.terminate }, c, d) } return f }
    function mo(a, b, c, d) {
        function e() {
            if (f[Eb.wi]) l(); else {
                ...
                Rk(c.id, f, "1"); var D = function () { var I = z() - H; Rk(c.id, f, "7", I); Qn(c.zb, A, "exception", I); B || (B = !0, l()) }; var H = z(); try { mc(w, { event: c, index: a, type: 1 }) } catch (I) { D(I) }
            }
        } var f = ec[a], g = b.O, l = b.N, m = b.terminate; if (c.ef(f)) return null; var n = nc(f[Eb.Sg], c, []);
        if (n && n.length) { var p = n[0], q = lo(p.index, { O: g, N: l, terminate: m }, c, d); if (!q) return null; g = q; l = 2 === p.eh ? m : q } if (f[Eb.Mg] || f[Eb.zi]) { var t = f[Eb.Mg] ? fc : c.Wj, u = g, r = l; if (!t[a]) { e = Fa(e); var v = no(a, t, e); g = v.O; l = v.N } return function () { t[a](u, r) } } return e
    } function no(a, b, c) { var d = [], e = []; b[a] = oo(d, e, c); return { O: function () { b[a] = po; for (var f = 0; f < d.length; f++)d[f]() }, N: function () { b[a] = qo; for (var f = 0; f < e.length; f++)e[f]() } } } function oo(a, b, c) { return function (d, e) { a.push(d); b.push(e); c() } } function po(a) { a() }
    ...
    var So = function (a) {
        var b = z(), c = a["gtm.uniqueEventId"], d = a["gtm.priorityId"], e = a.event; if ("gtm.js" === e) { if (No) return !1; No = !0; } var l, m = !1; if (Ho(c)) l = Go(c); else { if ("gtm.js" !== e && "gtm.init" !== e && "gtm.init_consent" !== e) return !1; m = !0; l = Go(Number.MAX_SAFE_INTEGER) } Qk(c, e); var n = a.eventCallback, p = a.eventTimeout,
            q = n; var t = { id: c, priorityId: d, name: e, ef: yn(l), Wj: [], lh: function () { O(6) }, Wg: Oo(), Xg: Po(c), zb: new On(q, p) }, u = sc(t); m && (u = Qo(u)); var r =
                Ko(u, t), v = !1; Un(t.zb); "gtm.js" !== e && "gtm.sync" !== e || fo(Gg.M); return Ro(u, r) || v
    }; function Po(a) { return function (b) { ek && (Db(b) || Zk(a, "input", b)) } } function Oo() { var a = {}; a.event = pe("event", 1); a.ecommerce = pe("ecommerce", 1); a.gtm = pe("gtm"); a.eventModel = pe("eventModel"); return a }
    function Qo(a) { for (var b = [], c = 0; c < a.length; c++)if (a[c]) { var d = String(ec[c][Eb.xb]), e; if (!(e = Od[d] || void 0 !== ec[c][Eb.Ai])) { var f = ec[c]["function"]; if (!f) throw "Error: No function name given for function call."; var g = gc[f]; e = g ? g.isInfrastructure || !1 : !1 } if (e || 0 === d.indexOf("__ccd") || 0 === d.indexOf("__ogt") || "__set_product_settings" === d) b[c] = !0 } return b } function Ro(a, b) { if (!b) return b; for (var c = 0; c < a.length; c++)if (a[c] && ec[c] && !Pd[String(ec[c][Eb.xb])]) return !0; return !1 } var Uo = function (a, b, c, d) { To.push("event", [b, a], c, d) }, Vo = function (a, b, c, d) { To.push("get", [a, b], c, d) }, up = function () { this.status = 1; this.D = {}; this.h = {}; this.K = {}; this.P = null; this.B = {}; this.m = !1 }, vp = function (a, b, c, d) { var e = z(); this.type = a; this.m = e; this.W = b || ""; this.h = c; this.messageContext = d }, wp = function () { this.m = {}; this.B = {}; this.h = [] }, xp = function (a, b) { var c = Xi(b); return a.m[c.T] = a.m[c.T] || new up }, yp = function (a, b, c, d) {
        if (d.W) {
            var e = xp(a, d.W), f = e.P; if (f) {
                var g = N(c), l = N(e.D[d.W]), m = N(e.B), n = N(e.h), p = N(a.B),
    ...
    wp.prototype.flush = function (a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            var f = this.h[0]; if (f.messageContext.deferrable) !f.W || xp(this, f.W).m ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift(); else {
                var g = void 0; switch (f.type) {
                    case "require": g = xp(this, f.W); if (3 !== g.status && !a) { this.h.push.apply(this.h, c); return } break; case "set": k(f.h[0], function (t, u) { N(Ja(t, u), b.B) }); break; case "config": g = xp(this, f.W); e.fb = {}; k(f.h[0], function (t) { return function (u, r) { N(Ja(u, r), t.fb) } }(e));
                        var l = !!e.fb[R.g.Lc]; delete e.fb[R.g.Lc]; var m = Xi(f.W), n = m.T === m.id; l || (n ? g.B = {} : g.D[f.W] = {}); g.m && l || yp(this, R.g.va, e.fb, f); g.m = !0; n ? N(e.fb, g.B) : (N(e.fb, g.D[f.W]), O(70)); d = !0; break; case "event": g = xp(this, f.W); e.kd = {}; k(f.h[0], function (t) { return function (u, r) { N(Ja(u, r), t.kd) } }(e)); yp(this, f.h[1], e.kd, f); break; case "get": g = xp(this, f.W); var p = {}, q = (p[R.g.Qa] = f.h[0], p[R.g.Za] = f.h[1], p); yp(this, R.g.Ca, q, f)
                }this.h.shift(); zp(this, f)
            } e = { fb: e.fb, kd: e.kd }
        } this.h.push.apply(this.h, c); d && this.flush()
    };
    var zp = function (a, b) { if ("require" !== b.type) if (b.W) for (var c = xp(a, b.W).K[b.type] || [], d = 0; d < c.length; d++)c[d](); else for (var e in a.m) if (a.m.hasOwnProperty(e)) { var f = a.m[e]; if (f && f.K) for (var g = f.K[b.type] || [], l = 0; l < g.length; l++)g[l]() } }, Ap = function (a, b) { var c = To, d = N(b); N(xp(c, a).h, d); xp(c, a).h = d }, To = new wp; var Bp = {}, Cp = {}, Dp = function (a) { for (var b = [], c = [], d = {}, e = 0; e < a.length; d = { pd: d.pd, md: d.md }, e++) { var f = a[e]; if (0 <= f.indexOf("-")) { if (d.pd = Xi(f), d.pd) { var g = Jg(); ra(g, function (q) { return function (t) { return q.pd.T === t } }(d)) ? b.push(f) : c.push(f) } } else { var l = Bp[f] || []; d.md = {}; l.forEach(function (q) { return function (t) { return q.md[t] = !0 } }(d)); for (var m = Ig(), n = 0; n < m.length; n++)if (d.md[m[n]]) { b = b.concat(Jg()); break } var p = Cp[f] || []; p.length && (b = b.concat(p)) } } return { wj: b, yj: c } }, Ep = function (a) {
        k(Bp, function (b, c) {
            var d =
                c.indexOf(a); 0 <= d && c.splice(d, 1)
        })
    }, Fp = function (a) { k(Cp, function (b, c) { var d = c.indexOf(a); 0 <= d && c.splice(d, 1) }) }; var Gp = "HA GF G UA AW DC MC".split(" "), Hp = !1, Ip = !1; function Jp(a, b) { a.hasOwnProperty("gtm.uniqueEventId") || Object.defineProperty(a, "gtm.uniqueEventId", { value: fe() }); b.eventId = a["gtm.uniqueEventId"]; b.priorityId = a["gtm.priorityId"]; return { eventId: b.eventId, priorityId: b.priorityId } }
    var Kp = {
        config: function (a, b) {
            var c = Jp(a, b); if (!(2 > a.length) && h(a[1])) {
                var d = {}; if (2 < a.length) { if (void 0 != a[2] && !J(a[2]) || 3 < a.length) return; d = a[2] } var e = Xi(a[1]); if (e) {
                    Qk(c.eventId, "gtag.config"); var f = e.T, g = e.id !== f; if (g ? -1 === Jg().indexOf(f) : -1 === Ig().indexOf(f)) { var l = d[R.g.na] || To.B[R.g.na]; g ? rn(f, l, { source: 2, fromContainerExecution: b.fromContainerExecution }) : qn(f, l, !0, { source: 2, fromContainerExecution: b.fromContainerExecution }) } else {
                        if (Sd && !g && !d[R.g.Lc]) { var m = Ip; Ip = !0; if (m) return } Hp || O(43); if (!b.noTargetGroup) if (g) {
                            Fp(e.id);
                            var n = e.id, p = d[R.g.Hd] || "default"; p = String(p).split(","); for (var q = 0; q < p.length; q++) { var t = Cp[p[q]] || []; Cp[p[q]] = t; 0 > t.indexOf(n) && t.push(n) }
                        } else { Ep(e.id); var u = e.id, r = d[R.g.Hd] || "default"; r = r.toString().split(","); for (var v = 0; v < r.length; v++) { var w = Bp[r[v]] || []; Bp[r[v]] = w; 0 > w.indexOf(u) && w.push(u) } } delete d[R.g.Hd]; var y = b.eventMetadata || {}; y.hasOwnProperty("is_external_event") || (y.is_external_event = !b.fromContainerExecution); b.eventMetadata = y; delete d[R.g.Mb]; for (var x = g ? [e.id] : Jg(), A = 0; A < x.length; A++) {
                            var B =
                                N(b); To.push("config", [d], x[A], B)
                        }
                    }
                }
            }
        }, consent: function (a, b) { if (3 === a.length) { O(39); var c = Jp(a, b), d = a[1]; "default" === d ? Sf(a[2]) : "update" === d && Uf(a[2], c) } }, event: function (a, b) {
            var c = a[1]; if (!(2 > a.length) && h(c)) {
                var d; if (2 < a.length) { if (!J(a[2]) && void 0 != a[2] || 3 < a.length) return; d = a[2] } var e = d, f = {}, g = (f.event = c, f); e && (g.eventModel = N(e), e[R.g.Mb] && (g.eventCallback = e[R.g.Mb]), e[R.g.Cd] && (g.eventTimeout = e[R.g.Cd])); var l = Jp(a, b), m = l.eventId, n = l.priorityId; g["gtm.uniqueEventId"] = m; n && (g["gtm.priorityId"] =
                    n); if ("optimize.callback" === c) return g.eventModel = g.eventModel || {}, g; var p; var q = d, t = q && q[R.g.wb]; void 0 === t && (t = le(R.g.wb, 2), void 0 === t && (t = "default")); if (h(t) || qa(t)) { var u = t.toString().replace(/\s+/g, "").split(","), r = Dp(u), v = r.wj, w = r.yj; if (w.length) for (var y = q && q[R.g.na] || To.B[R.g.na], x = 0; x < w.length; x++) { var A = Xi(w[x]); A && rn(A.T, y, { source: 3, fromContainerExecution: b.fromContainerExecution }) } p = Zi(v) } else p = void 0; var B = p; if (B) {
                        Qk(m, c); for (var D = [], H = 0; H < B.length; H++) {
                            var I = B[H], C = N(b); if (-1 !== Gp.indexOf(I.prefix)) {
                                var K =
                                    N(d), M = C.eventMetadata || {}; M.hasOwnProperty("is_external_event") || (M.is_external_event = !C.fromContainerExecution); C.eventMetadata = M; delete K[R.g.Mb]; Uo(c, K, I.id, C)
                            } D.push(I.id)
                        } g.eventModel = g.eventModel || {}; 0 < B.length ? g.eventModel[R.g.wb] = D.join() : delete g.eventModel[R.g.wb]; Hp || O(43); return b.noGtmEvent ? void 0 : g
                    }
            }
        }, get: function (a, b) {
            O(53); if (4 === a.length && h(a[1]) && h(a[2]) && oa(a[3])) {
                var c = Xi(a[1]), d = String(a[2]), e = a[3]; if (c) {
                    Hp || O(43); var f = To.B[R.g.na]; if (!ra(Jg(), function (l) { return c.T === l })) rn(c.T,
                        f, { source: 4, fromContainerExecution: b.fromContainerExecution }); else if (-1 !== Gp.indexOf(c.prefix)) { Jp(a, b); var g = {}; Of(N((g[R.g.Qa] = d, g[R.g.Za] = e, g))); Vo(d, function (l) { G(function () { return e(l) }) }, c.id, b) }
                }
            }
        }, js: function (a, b) { if (2 == a.length && a[1].getTime) { Hp = !0; var c = Jp(a, b), d = c.eventId, e = c.priorityId, f = {}; return f.event = "gtm.js", f["gtm.start"] = a[1].getTime(), f["gtm.uniqueEventId"] = d, f["gtm.priorityId"] = e, f } }, policy: function () { }, set: function (a, b) {
            var c; 2 == a.length && J(a[1]) ? c = N(a[1]) : 3 == a.length && h(a[1]) &&
                (c = {}, J(a[2]) || qa(a[2]) ? c[a[1]] = N(a[2]) : c[a[1]] = a[2]); if (c) { var d = Jp(a, b), e = d.eventId, f = d.priorityId; N(c); var g = N(c); To.push("set", [g], void 0, b); c["gtm.uniqueEventId"] = e; f && (c["gtm.priorityId"] = f); Wc(30) && delete c.event; b.overwriteModelFields = !0; return c }
        }
    }, Lp = { policy: !0 }; var Mp = function (a) { var b = E[Ld.fa].hide; if (b && void 0 !== b[a] && b.end) { b[a] = !1; var c = !0, d; for (d in b) if (b.hasOwnProperty(d) && !0 === b[d]) { c = !1; break } c && (b.end(), b.end = null) } }, Np = function (a) { var b = E[Ld.fa], c = b && b.hide; c && c.end && (c[a] = !0) }; var Op = !1, Pp = []; function Qp() { if (!Op) { Op = !0; for (var a = 0; a < Pp.length; a++)G(Pp[a]) } } var Rp = function (a) { Op ? G(a) : Pp.push(a) }; var hq = function (a) { if (gq(a)) return a; this.h = a }; hq.prototype.getUntrustedMessageValue = function () { return this.h }; var gq = function (a) { return !a || "object" !== Bb(a) || J(a) ? !1 : "getUntrustedMessageValue" in a }; hq.prototype.getUntrustedMessageValue = hq.prototype.getUntrustedMessageValue; var iq = 0, jq = {}, kq = [], lq = [], mq = !1, nq = !1; function oq(a, b) { return a.messageContext.eventId - b.messageContext.eventId || a.messageContext.priorityId - b.messageContext.priorityId } var pq = function (a) { return E[Ld.fa].push(a) }, qq = function (a, b) { var c = Md[Ld.fa], d = c ? c.subscribers : 1, e = 0, f = !1, g = void 0; b && (g = E.setTimeout(function () { f || (f = !0, a()); g = void 0 }, b)); return function () { ++e === d && (g && (E.clearTimeout(g), g = void 0), f || (a(), f = !0)) } };
    ...
    function tq() {
        var a; if (lq.length) a = lq.shift(); else if (kq.length) a = kq.shift(); else return; var b; var c = a; if (mq || !sq(c.message)) b = c; else {
            mq = !0; var d = c.message["gtm.uniqueEventId"]; "number" !== typeof d && (d = c.message["gtm.uniqueEventId"] = fe()); var e = {}, f = { message: (e.event = "gtm.init_consent", e["gtm.uniqueEventId"] = d - 2, e), messageContext: { eventId: d - 2 } }, g = {}, l = { message: (g.event = "gtm.init", g["gtm.uniqueEventId"] = d - 1, g), messageContext: { eventId: d - 1 } }; kq.unshift(l, c); if (ek && Gg.M) {
                var m; if (Gg.Kg) {
                    var n = Gg.M, p = Lg().destination[n];
                    m = p && p.context
                } else { var q = Gg.M, t = Lg().container[q]; m = t && t.context } var u = m, r, v = Le(E.location.href); r = v.hostname + v.pathname; var w = u && u.fromContainerExecution, y = u && u.source, x = Gg.M, A = Gg.Hb, B = Gg.Kg; qk || (qk = r); pk.push(x + ";" + A + ";" + (w ? 1 : 0) + ";" + (y || 0) + ";" + (B ? 1 : 0))
            } b = f
        } return b
    }
    function uq() {
        for (var a = !1, b; !nq && (b = tq());) {
            nq = !0; delete ie.eventModel; ke(); var c = b, d = c.message, e = c.messageContext; if (null == d) nq = !1; else {
                if (e.fromContainerExecution) for (var f = ["gtm.allowlist", "gtm.blocklist", "gtm.whitelist", "gtm.blacklist", "tagTypeBlacklist"], g = 0; g < f.length; g++) { var l = f[g], m = le(l, 1); if (qa(m) || J(m)) m = N(m); je[l] = m } try {
                    if (oa(d)) try { d.call(me) } catch (A) { } else if (qa(d)) {
                        var n =
                            d; if (h(n[0])) { var p = n[0].split("."), q = p.pop(), t = n.slice(1), u = le(p.join("."), 2); if (null != u) try { u[q].apply(u, t) } catch (A) { } }
                    } else { var r = void 0; if (xa(d)) { a: { if (d.length && h(d[0])) { var v = Kp[d[0]]; if (v && (!e.fromContainerExecution || !Lp[d[0]])) { r = v(d, e); break a } } r = void 0 } r && "set" === d[0] && r.event && O(101) } else r = d; r && (a = rq(r, e) || a) }
                } finally {
                    e.fromContainerExecution && ke(!0); var w = d["gtm.uniqueEventId"]; if ("number" === typeof w) {
                        for (var y = jq[String(w)] || [], x = 0; x < y.length; x++)lq.push(vq(y[x])); y.length && lq.sort(oq);
                        delete jq[String(w)]; w > iq && (iq = w)
                    } nq = !1
                }
            }
        } return !a
    } function wq() { var b = uq(); try { Mp(Gg.M) } catch (c) { } return b }
    ...
    var yq = function () {
        function a(f) { var g = {}; if (gq(f)) { var l = f; f = gq(l) ? l.getUntrustedMessageValue() : void 0; g.fromContainerExecution = !0 } return { message: f, messageContext: g } } var b = ib(Ld.fa, []), c = Md[Ld.fa] = Md[Ld.fa] || {}; !0 === c.pruned && O(83); jq = vo().get(); yo(); Ln(function () { if (!c.gtmDom) { c.gtmDom = !0; var f = {}; b.push((f.event = "gtm.dom", f)) } }); Rp(function () { if (!c.gtmLoad) { c.gtmLoad = !0; var f = {}; b.push((f.event = "gtm.load", f)) } }); c.subscribers = (c.subscribers || 0) + 1; var d = b.push; b.push = function () {
            var f; if (0 < Md.SANDBOXED_JS_SEMAPHORE) {
                f =
                    []; for (var g = 0; g < arguments.length; g++)f[g] = new hq(arguments[g])
            } else f = [].slice.call(arguments, 0); var l = f.map(function (q) { return a(q) }); kq.push.apply(kq, l); var m = d.apply(b, f), n = Math.max(100, Number("1000") || 300); if (this.length > n) for (O(4), c.pruned = !0; this.length > n;)this.shift(); var p = "boolean" !== typeof m || m; return uq() && p
        }; var e = b.slice(0).map(function (f) { return a(f) }); kq.push.apply(kq, e); if (xq()) { G(wq) }
    }, xq = function () { var a = !0; return a }; function zq(a) { if (null == a || 0 === a.length) return !1; var b = Number(a), c = z(); return b < c + 3E5 && b > c - 9E5 }; var jc = {}; jc.Od = new String("undefined"); var $q = E.clearTimeout, ar = E.setTimeout, V = function (a, b, c, d) { if (Fg()) { b && G(b) } else return nb(a, b, c, d) }, br = function () { return new Date }, cr = function () { return E.location.href }, dr = function (a) { return Je(Le(a), "fragment") }, er = function (a) { return Ke(Le(a)) }, fr = function (a, b) { return le(a, b || 2) }, gr = function (a, b, c) { var d; b ? (a.eventCallback = b, c && (a.eventTimeout = c), d = pq(a)) : d = pq(a); return d }, hr = function (a, b) { E[a] = b }, W = function (a, b, c) {
        b &&
            (void 0 === E[a] || c && !E[a]) && (E[a] = b); return E[a]
    }, ir = function (a, b, c) { return fg(a, b, void 0 === c ? !0 : !!c) }, jr = function (a, b, c) { return 0 === og(a, b, c) }, kr = function (a, b) { if (Fg()) { b && G(b) } else pb(a, b) }, lr = function (a) { return !!Gq(a, "init", !1) }, mr = function (a) { Eq(a, "init", !0) }, nr = function (a, b, c) { ek && (Db(a) || Zk(c, b, a)) };
    ...
    function Rr(a) {
        var b = a.arg0, c = a.arg1; if (a.any_of && Array.isArray(c)) { for (var d = 0; d < c.length; d++) { var e = N(a, {}); N({ arg1: c[d], any_of: void 0 }, e); if (Qr(e)) return !0 } return !1 } switch (a["function"]) {
            case "_cn": return 0 <= String(b).indexOf(String(c)); case "_css": var f; a: { if (b) try { for (var g = 0; g < Lr.length; g++) { var l = Lr[g]; if (b[l]) { f = b[l](c); break a } } } catch (m) { } f = !1 } return f; case "_ew": return Mr(b, c); case "_eq": return String(b) === String(c); case "_ge": return Number(b) >= Number(c); case "_gt": return Number(b) > Number(c);
            case "_lc": return 0 <= String(b).split(",").indexOf(String(c)); case "_le": return Number(b) <= Number(c); case "_lt": return Number(b) < Number(c); case "_re": return Or(b, c, a.ignore_case); case "_sw": return 0 === String(b).indexOf(String(c)); case "_um": return Pr(b, c)
        }return !1
    ...
    var Ju = function (a, b) { if (!b.C) { var c = U(b, R.g.Qa), d = U(b, R.g.Za), e = U(b, c); if (void 0 === e) { var f = void 0; Gu.hasOwnProperty(c) ? f = Gu[c] : Hu.hasOwnProperty(c) && (f = Hu[c]); 1 === f && (f = Iu(c)); h(f) ? $n()(function () { var g = $n().getByName(a).get(f); d(g) }) : d(void 0) } else d(e) } }, Ku = function (a, b) { var c = a[R.g.Jc], d = b + ".", e = a[R.g.R] || "", f = void 0 === c ? !!a.use_anchor : "fragment" === c, g = !!a[R.g.Qb]; e = String(e).replace(/\s+/g, "").split(","); var l = $n(); l(d + "require", "linker"); l(d + "linker:autoLink", e, f, g) }, Ou = function (a, b, c) {
        if (If() &&
            (!c.C || !Lu[a])) {
            var d = !Vf(R.g.U), e = function (f) {
                var g, l, m = $n(), n = Mu(b, "", c), p, q = n.createOnlyFields._useUp; if (c.C || Nu(b, n.createOnlyFields)) {
                    c.C && (g = "gtm" + fe(), l = n.createOnlyFields, n.gtmTrackerName && (l.name = g)); m(function () { var u = m.getByName(b); u && (p = u.get("clientId")); c.C || m.remove(b) }); m("create", a, c.C ? l : n.createOnlyFields); d &&
                        Vf(R.g.U) && (d = !1, m(function () { var u = $n().getByName(c.C ? g : b); !u || u.get("clientId") == p && q || (c.C ? (n.fieldsToSet["&gcu"] = "1", n.fieldsToSet["&gcut"] = Hd[f]) : (n.fieldsToSend["&gcu"] = "1", n.fieldsToSend["&gcut"] = Hd[f]), u.set(n.fieldsToSet), c.C ? u.send("pageview") : u.send("pageview", n.fieldsToSend)) })); c.C && m(function () { m.remove(g) })
                }
            }; Xf(function () { return e(R.g.U) }, R.g.U); Xf(function () { return e(R.g.F) }, R.g.F); c.C && (Lu[a] = !0)
        }
    }, Pu = function (a, b) { on() && b && (a[R.g.ub] = b) }, Yu = function (a, b, c) {
        function d() {
            var C = U(c,
                R.g.Dc); l(function () { if (!c.C && J(C)) { var K = r.fieldsToSend, M = m().getByName(n), T; for (T in C) if (C.hasOwnProperty(T) && /^(dimension|metric)\d+$/.test(T) && void 0 != C[T]) { var ca = M.get(Iu(C[T])); Qu(K, T, ca) } } })
        } function e() { if (r.displayfeatures) { var C = "_dc_gtm_" + f.replace(/[^A-Za-z0-9-]/g, ""); p("require", "displayfeatures", void 0, { cookieName: C }) } } var f = a, g = "https://www.google-analytics.com/analytics.js", l = c.C ? bo(U(c, "gaFunctionName")) : bo(); if (oa(l)) {
            var m = $n, n; c.C ? n = U(c, "name") || U(c, "gtmTrackerName") : n = "gtag_" +
                f.split("-").join("_"); var p = function (C) { var K = [].slice.call(arguments, 0); K[0] = n ? n + "." + K[0] : "" + K[0]; l.apply(window, K) }, q = function (C) {
                    var K = function (X, Q) { for (var P = 0; Q && P < Q.length; P++)p(X, Q[P]) }, M = c.C, T = M ? Ru(r) : Su(b, c); if (T) {
                        var ca = {}; Pu(ca, C); p("require", "ec", "ec.js", ca); M && T.Xe && p("set", "&cu", T.Xe); var S = T.action; if (M || "impressions" === S) if (K("ec:addImpression", T.jh), !M) return; if ("promo_click" === S || "promo_view" === S || M && T.dd) {
                            var L = T.dd; K("ec:addPromo", L); if (L && 0 < L.length && "promo_click" === S) {
                                M ? p("ec:setAction",
                                    S, T.Ra) : p("ec:setAction", S); return
                            } if (!M) return
                        } "promo_view" !== S && "impressions" !== S && (K("ec:addProduct", T.Bb), p("ec:setAction", S, T.Ra))
                    }
                }, t = function (C) { if (C) { var K = {}; if (J(C)) for (var M in Tu) Tu.hasOwnProperty(M) && Uu(Tu[M], M, C[M], K); Pu(K, y); p("require", "linkid", K) } }, u = function () { if (Fg()) { } else { var C = U(c, R.g.fi); C && (p("require", C, { dataLayer: Ld.fa }), p("require", "render")) } }, r = Mu(n, b, c), v = function (C, K, M) {
                    M && (K = "" + K); r.fieldsToSend[C] =
                        K
                }; !c.C && Nu(n, r.createOnlyFields) && (l(function () { m() && m().remove(n) }), Vu[n] = !1); l("create", f, r.createOnlyFields); if (r.createOnlyFields[R.g.ub] && !c.C) { var w = nn(r.createOnlyFields[R.g.ub], "/analytics.js"); w && (g = w) } var y = c.C ? r.fieldsToSet[R.g.ub] : r.createOnlyFields[R.g.ub]; if (y) { var x = c.C ? r.fieldsToSet[R.g.Ed] : r.createOnlyFields[R.g.Ed]; x && !Vu[n] && (Vu[n] = !0, l(go(n, x))) } c.C ? r.enableRecaptcha && p("require", "recaptcha", "recaptcha.js") : (d(), t(r.linkAttribution)); var A = r[R.g.ra]; A && A[R.g.R] && Ku(A, n); p("set",
                    r.fieldsToSet); if (c.C) { if (r.enableLinkId) { var B = {}; Pu(B, y); p("require", "linkid", "linkid.js", B) } If() && Ou(f, n, c) } if (b === R.g.qc) if (c.C) { e(); if (r.remarketingLists) { var D = "_dc_gtm_" + f.replace(/[^A-Za-z0-9-]/g, ""); p("require", "adfeatures", { cookieName: D }) } q(y); p("send", "pageview"); r.createOnlyFields._useUp && co(n + ".") } else u(), p("send", "pageview", r.fieldsToSend); else b === R.g.va ? (u(), Aj(f, c), U(c, R.g.ab) && (Mi(["aw", "dc"]), co(n + ".")), 0 != r.sendPageView && p("send", "pageview", r.fieldsToSend), Ou(f, n, c)) : b === R.g.Ca ?
                        Ju(n, c) : "screen_view" === b ? p("send", "screenview", r.fieldsToSend) : "timing_complete" === b ? (r.fieldsToSend.hitType = "timing", v("timingCategory", r.eventCategory, !0), c.C ? v("timingVar", r.timingVar, !0) : v("timingVar", r.name, !0), v("timingValue", za(r.value)), void 0 !== r.eventLabel && v("timingLabel", r.eventLabel, !0), p("send", r.fieldsToSend)) : "exception" === b ? p("send", "exception", r.fieldsToSend) : "" === b && c.C || ("track_social" === b && c.C ? (r.fieldsToSend.hitType = "social", v("socialNetwork", r.socialNetwork, !0), v("socialAction",
                            r.socialAction, !0), v("socialTarget", r.socialTarget, !0)) : ((c.C || Wu[b]) && q(y), c.C && e(), r.fieldsToSend.hitType = "event", v("eventCategory", r.eventCategory, !0), v("eventAction", r.eventAction || b, !0), void 0 !== r.eventLabel && v("eventLabel", r.eventLabel, !0), void 0 !== r.value && v("eventValue", za(r.value))), p("send", r.fieldsToSend)); if (!Xu && !c.C) { Xu = !0; Vn(); var H = function () { c.N() }, I = function () { m().loaded || H() }; Fg() ? G(I) : nb(g, I, H) }
        } else G(c.N)
    }, Zu = function (a, b, c, d) { Yf(function () { Yu(a, b, d) }, [R.g.U, R.g.F]) }, bv = function (a,
        b) {
        function c(f) {
            function g(n, p) { for (var q = 0; q < p.length; q++) { var t = p[q]; if (f[t]) { m[n] = f[t]; break } } } function l() { if (f.category) m.category = f.category; else { for (var n = "", p = 0; p < $u.length; p++)void 0 !== f[$u[p]] && (n && (n += "/"), n += f[$u[p]]); n && (m.category = n) } } var m = N(f); if (av || b) g("id", ["id", "item_id", "promotion_id"]), g("name", ["name", "item_name", "promotion_name"]), g("brand", ["brand", "item_brand"]), g("variant", ["variant", "item_variant"]), g("list", ["list_name", "item_list_name"]), g("position", ["list_position",
                "creative_slot", "index"]), l(); g("listPosition", ["list_position"]); g("creative", ["creative_name"]); g("list", ["list_name"]); g("position", ["list_position", "creative_slot"]); return m
        } b = void 0 === b ? !1 : b; for (var d = [], e = 0; a && e < a.length; e++)a[e] && J(a[e]) && d.push(c(a[e])); return d.length ? d : void 0
    }, cv = function (a) { return Vf(a) }, dv = !1; var av = !1;
    av = !0; var Xu, Vu = {}, Lu = {}, ev = {}, Gu = Object.freeze((ev.client_storage = "storage", ev.sample_rate = 1, ev.site_speed_sample_rate = 1, ev.store_gac = 1, ev.use_amp_client_id = 1, ev[R.g.jb] = 1, ev[R.g.qa] = "storeGac", ev[R.g.Xa] = 1, ev[R.g.Ia] = 1, ev[R.g.Ya] = 1, ev[R.g.Bc] = 1, ev[R.g.we] = 1, ev[R.g.tb] = 1, ev)), fv = {}, gv = Object.freeze((fv._cs = 1, fv._useUp = 1, fv.allowAnchor = 1, fv.allowLinker = 1, fv.alwaysSendReferrer = 1, fv.clientId = 1, fv.cookieDomain = 1, fv.cookieExpires = 1, fv.cookieFlags =
        1, fv.cookieName = 1, fv.cookiePath = 1, fv.cookieUpdate = 1, fv.legacyCookieDomain = 1, fv.legacyHistoryImport = 1, fv.name = 1, fv.sampleRate = 1, fv.siteSpeedSampleRate = 1, fv.storage = 1, fv.storeGac = 1, fv.useAmpClientId = 1, fv._cd2l = 1, fv)), hv = Object.freeze({ anonymize_ip: 1 }), iv = {}, Hu = Object.freeze((iv.campaign = { content: "campaignContent", id: "campaignId", medium: "campaignMedium", name: "campaignName", source: "campaignSource", term: "campaignKeyword" }, iv.app_id = 1, iv.app_installer_id = 1, iv.app_name = 1, iv.app_version = 1, iv.description =
            "exDescription", iv.fatal = "exFatal", iv.language = 1, iv.page_hostname = "hostname", iv.transport_type = "transport", iv[R.g.ma] = "currencyCode", iv[R.g.ig] = 1, iv[R.g.Ka] = "location", iv[R.g.De] = "page", iv[R.g.La] = "referrer", iv[R.g.Sb] = "title", iv[R.g.qg] = 1, iv[R.g.sa] = 1, iv)), jv = {}, kv = Object.freeze((jv.content_id = 1, jv.event_action = 1, jv.event_category = 1, jv.event_label = 1, jv.link_attribution = 1, jv.name = 1, jv[R.g.ra] = 1, jv[R.g.hg] = 1, jv[R.g.xa] = 1, jv[R.g.ka] = 1, jv)), lv = Object.freeze({
                displayfeatures: 1, enableLinkId: 1, enableRecaptcha: 1,
                eventAction: 1, eventCategory: 1, eventLabel: 1, gaFunctionName: 1, gtmEcommerceData: 1, gtmTrackerName: 1, linker: 1, remarketingLists: 1, socialAction: 1, socialNetwork: 1, socialTarget: 1, timingVar: 1, value: 1
            }), $u = Object.freeze(["item_category", "item_category2", "item_category3", "item_category4", "item_category5"]), mv = {}, Tu = Object.freeze((mv.levels = 1, mv[R.g.Ia] = "duration", mv[R.g.Bc] = 1, mv)), nv = {}, ov = Object.freeze((nv.anonymize_ip = 1, nv.fatal = 1, nv.send_page_view = 1, nv.store_gac = 1, nv.use_amp_client_id = 1, nv[R.g.qa] = 1, nv[R.g.ig] =
                1, nv)), Uu = function (a, b, c, d) { if (void 0 !== c) if (ov[b] && (c = Aa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Iu(b)] = c; else if (h(a)) d[a] = c; else for (var e in a) a.hasOwnProperty(e) && void 0 !== c[e] && (d[a[e]] = c[e]) }, Iu = function (a) { return a && h(a) ? a.replace(/(_[a-z])/g, function (b) { return b[1].toUpperCase() }) : a }, pv = {}, Wu = Object.freeze((pv.checkout_progress = 1, pv.select_content = 1, pv.set_checkout_option = 1, pv[R.g.kc] = 1, pv[R.g.mc] = 1, pv[R.g.Ib] = 1, pv[R.g.nc] = 1, pv[R.g.rb] = 1, pv[R.g.Jb] = 1, pv[R.g.sb] = 1, pv[R.g.Ba] = 1, pv[R.g.oc] =
                    1, pv[R.g.Ha] = 1, pv)), qv = {}, rv = Object.freeze((qv.checkout_progress = 1, qv.set_checkout_option = 1, qv[R.g.Jf] = 1, qv[R.g.Kf] = 1, qv[R.g.kc] = 1, qv[R.g.mc] = 1, qv[R.g.Lf] = 1, qv[R.g.Ib] = 1, qv[R.g.Ba] = 1, qv[R.g.oc] = 1, qv[R.g.Mf] = 1, qv)), sv = {}, tv = Object.freeze((sv.generate_lead = 1, sv.login = 1, sv.search = 1, sv.select_content = 1, sv.share = 1, sv.sign_up = 1, sv.view_search_results = 1, sv[R.g.nc] = 1, sv[R.g.rb] = 1, sv[R.g.Jb] = 1, sv[R.g.sb] = 1, sv[R.g.Ha] = 1, sv)), uv = function (a) {
                        var b = "general"; rv[a] ? b = "ecommerce" : tv[a] ? b = "engagement" : "exception" ===
                            a && (b = "error"); return b
                    }, vv = {}, wv = Object.freeze((vv.view_search_results = 1, vv[R.g.rb] = 1, vv[R.g.sb] = 1, vv[R.g.Ha] = 1, vv)), Qu = function (a, b, c) { a.hasOwnProperty(b) || (a[b] = c) }, xv = function (a) { if (qa(a)) { for (var b = [], c = 0; c < a.length; c++) { var d = a[c]; if (void 0 != d) { var e = d.id, f = d.variant; void 0 != e && void 0 != f && b.push(String(e) + "." + String(f)) } } return 0 < b.length ? b.join("!") : void 0 } }, Mu = function (a, b, c) {
                        var d = function (K) { return U(c, K) }, e = {}, f = {}, g = {}, l = {}, m = xv(d(R.g.ei)); !c.C && m && Qu(f, "exp", m); g["&gtm"] = Rg(!0); If() &&
                            (l._cs = cv); var n = d(R.g.Dc); if (!c.C && J(n)) for (var p in n) if (n.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != n[p]) { var q = d(String(n[p])); void 0 !== q && Qu(f, p, q) } for (var t = il(c), u = 0; u < t.length; ++u) {
                                var r = t[u]; if (c.C) { var v = d(r); lv.hasOwnProperty(r) ? e[r] = v : gv.hasOwnProperty(r) ? l[r] = v : g[r] = v } else {
                                    var w = void 0; w = r !== R.g.aa ? d(r) : jl(c, r); if (kv.hasOwnProperty(r)) Uu(kv[r], r, w, e); else if (hv.hasOwnProperty(r)) Uu(hv[r], r, w, g); else if (Hu.hasOwnProperty(r)) Uu(Hu[r], r, w, f); else if (Gu.hasOwnProperty(r)) Uu(Gu[r],
                                        r, w, l); else if (/^(dimension|metric|content_group)\d+$/.test(r)) Uu(1, r, w, f); else if (r === R.g.aa) { if (!dv) { var y = La(w); y && (f["&did"] = y) } var x = void 0, A = void 0; b === R.g.va ? x = La(jl(c, r), ".") : (x = La(jl(c, r, 1), "."), A = La(jl(c, r, 2), ".")); x && (f["&gdid"] = x); A && (f["&edid"] = A) } else r === R.g.Pa && 0 > t.indexOf(R.g.Bc) && (l.cookieName = w + "_ga")
                                }
                            } !1 !== d(R.g.Uh) && !1 !== d(R.g.uc) && Hs() || (g.allowAdFeatures = !1); !1 !== d(R.g.X) && Is() || (g.allowAdPersonalizationSignals = !1); !c.C && d(R.g.ab) && (l._useUp = !0); if (c.C) {
                                l.name = l.name || e.gtmTrackerName;
                                var B = g.hitCallback; g.hitCallback = function () { oa(B) && B(); c.O() }
                            } else { Qu(l, "cookieDomain", "auto"); Qu(g, "forceSSL", !0); Qu(e, "eventCategory", uv(b)); wv[b] && Qu(f, "nonInteraction", !0); "login" === b || "sign_up" === b || "share" === b ? Qu(e, "eventLabel", d(R.g.hg)) : "search" === b || "view_search_results" === b ? Qu(e, "eventLabel", d(R.g.li)) : "select_content" === b && Qu(e, "eventLabel", d(R.g.Xh)); var D = e[R.g.ra] || {}, H = D[R.g.Pb]; H || 0 != H && D[R.g.R] ? l.allowLinker = !0 : !1 === H && Qu(l, "useAmpClientId", !1); f.hitCallback = c.O; l.name = a } If() && (g["&gcs"] =
                                Wf(), Vf(R.g.U) || (l.storage = "none"), Vf(R.g.F) || (g.allowAdFeatures = !1, l.storeGac = !1)); var I = d(R.g.na) || d(R.g.ub), C = d(R.g.Ed); I && (c.C || (l[R.g.ub] = I), l._cd2l = !0); C && !c.C && (l[R.g.Ed] = C); e.fieldsToSend = f; e.fieldsToSet = g; e.createOnlyFields = l; return e
                    }, Ru = function (a) {
                        var b = a.gtmEcommerceData; if (!b) return null; var c = {}; b.currencyCode && (c.Xe = b.currencyCode); if (b.impressions) { c.action = "impressions"; var d = b.impressions; c.jh = "impressions" === b.translateIfKeyEquals ? bv(d, !0) : d } if (b.promoView) {
                            c.action = "promo_view";
                            var e = b.promoView.promotions; c.dd = "promoView" === b.translateIfKeyEquals ? bv(e, !0) : e
                        } if (b.promoClick) { c.action = "promo_click"; var f = b.promoClick.promotions; c.dd = "promoClick" === b.translateIfKeyEquals ? bv(f, !0) : f; c.Ra = b.promoClick.actionField; return c } for (var g in b) if (b.hasOwnProperty(g) && "translateIfKeyEquals" !== g && "impressions" !== g && "promoView" !== g && "promoClick" !== g && "currencyCode" !== g) { c.action = g; var l = b[g].products; c.Bb = "products" === b.translateIfKeyEquals ? bv(l, !0) : l; c.Ra = b[g].actionField; break } return Object.keys(c).length ?
                            c : null
                    }, Su = function (a, b) {
                        function c(v) { return { id: d(R.g.Ea), affiliation: d(R.g.bi), revenue: d(R.g.ka), tax: d(R.g.Tf), shipping: d(R.g.Ec), coupon: d(R.g.ci), list: e() || v } } for (var d = function (v) { return U(b, v) }, e = function () { var v; av && (v = d(R.g.Rf)); return d(R.g.Sf) || v }, f = d(R.g.Z), g, l = 0; f && l < f.length && (g = f[l][R.g.Sf], !g && av && (g = f[l][R.g.Rf]), !g); l++); var m = d(R.g.Dc); if (J(m)) for (var n = 0; f && n < f.length; ++n) { var p = f[n], q; for (q in m) m.hasOwnProperty(q) && /^(dimension|metric)\d+$/.test(q) && void 0 != m[q] && Qu(p, q, p[m[q]]) } var t =
                            null, u = d(R.g.di); if (a === R.g.Ba || a === R.g.oc) t = { action: a, Ra: c(), Bb: bv(f) }; else if (a === R.g.kc) t = { action: "add", Ra: c(), Bb: bv(f) }; else if (a === R.g.mc) t = { action: "remove", Ra: c(), Bb: bv(f) }; else if (a === R.g.Ha) t = { action: "detail", Ra: c(g), Bb: bv(f) }; else if (a === R.g.rb) t = { action: "impressions", jh: bv(f) }; else if (a === R.g.sb) t = { action: "promo_view", dd: av ? bv(u) || bv(f) : bv(u) }; else if ("select_content" === a && u && 0 < u.length || av && a === R.g.Jb) t = { action: "promo_click", dd: av ? bv(u) || bv(f) : bv(u) }; else if ("select_content" === a || av && a ===
                                R.g.nc) t = { action: "click", Ra: { list: e() || g }, Bb: bv(f) }; else if (a === R.g.Ib || "checkout_progress" === a) { var r = { step: a === R.g.Ib ? 1 : d(R.g.Qf), option: d(R.g.Pf) }; t = { action: "checkout", Bb: bv(f), Ra: N(c(), r) } } else "set_checkout_option" === a && (t = { action: "checkout_option", Ra: { step: d(R.g.Qf), option: d(R.g.Pf) } }); t && (t.Xe = d(R.g.ma)); return t
                    }, yv = {}, Nu = function (a, b) {
                        var c = yv[a]; yv[a] = N(b); if (!c) return !1; for (var d in b) if (b.hasOwnProperty(d) && b[d] !== c[d]) return !0; for (var e in c) if (c.hasOwnProperty(e) && c[e] !== b[e]) return !0;
                        return !1
                    }; var zv = Ct; var Bv = encodeURI, Y = encodeURIComponent, Cv = function (a, b, c) { qb(a, b, c) }, Dv = function (a, b) { if (!a) return !1; var c = Je(Le(a), "host"); if (!c) return !1; for (var d = 0; b && d < b.length; d++) { var e = b[d] && b[d].toLowerCase(); if (e) { var f = c.length - e.length; 0 < f && "." != e.charAt(0) && (f--, e = "." + e); if (0 <= f && c.indexOf(e, f) == f) return !0 } } return !1 }, Ev = function (a, b, c) {
    ...
    Z.o.rep = ["google"], function () {
        (function (a) { Z.__rep = a; Z.__rep.s = "rep"; Z.__rep.isVendorTemplate = !0; Z.__rep.priorityOverride = 0; Z.__rep.isInfrastructure = !1 })(function (a) {
            var b = Xi(a.vtp_containerId), c; switch (b.prefix) {
                case "AW": c = hu; break; case "DC": c = ru; break; case "GF": c =
                    xu; break; case "HA": c = Cu; break; case "UA": c = Zu; break; case "MC": break; default: G(a.vtp_gtmOnFailure); return
    ...
    (function (a) {
        if (!E["__TAGGY_INSTALLED"]) { var b = !1; if (F.referrer) { var c = Le(F.referrer); b = "cct.google" === Ie(c, "host") } if (!b) { var d = fg("googTaggyReferrer"); b = d.length && d[0].length } b && (E["__TAGGY_INSTALLED"] = !0, nb("https://cct.google/taggy/agent.js")) } if (Zd) a(); else {
            var e = function (p) {
                var q = "GTM", t = "GTM"; Td ? (q = "OGT", t = "GTAG") : Zd && (t = q = "OPT"); var u = E["google.tagmanager.debugui2.queue"]; u || (u = [], E["google.tagmanager.debugui2.queue"] = u, nb("https://" + Ld.qd + "/debug/bootstrap?id=" + Gg.M + "&src=" + t + "&cond=" +
                    p + "&gtm=" + Rg())); var r = { messageType: "CONTAINER_STARTING", data: { scriptSource: hb, containerProduct: q, debug: !1, id: Gg.M, isGte: Sd } }; r.data.resume = function () { a() }; Ld.Jh && (r.data.initialPublish = !0); u.push(r)
            }, f = void 0, g = Je(E.location, "query", !1, void 0, "gtm_debug"); zq(g) && (f = 2); if (!f && F.referrer) { var l = Le(F.referrer); "tagassistant.google.com" === Ie(l, "host") && (f = 3) } if (!f) { var m = fg("__TAG_ASSISTANT"); m.length && m[0].length && (f = 4) } if (!f) {
                var n = F.documentElement.getAttribute("data-tag-assistant-present"); zq(n) &&
                    (f = 5)
            } f && hb ? e(f) : a()
        }
    })(function () {
        var a = !1; a && Wn("INIT"); wf().m(); uh(); ni.enable_gbraid_cookie_write = !0; var b = !!Md[Gg.M]; !b && Gg.Hb && (b = !!Md["ctid_" + Gg.Hb]); if (b) { var c = Md.zones; c && c.unregisterChild(Ig()); } else {
...
gtag('set', 'linker', { "domains": ["pgking168.co"] });
gtag("js", new Date());
gtag("set", "developer_id.dZTNiMT", true);
gtag("config", "UA-176299553-23", { "anonymize_ip": true });
gtag("config", "G-9E0X3RLRD3");
...
})(window, document, 'script', 'dataLayer', 'GTM-WFTMV8C');
